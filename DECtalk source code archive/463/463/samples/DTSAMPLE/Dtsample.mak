...
OUTDIR=.\build\it\da32stat
INTDIR=.\build\it\da32stat\link

ALL : ".\build\fr\da32stat\Dtaccess.exe"
...
CLEAN :
	...
	-@erase "$(INTDIR)\vc60.pdb"
	-@erase "$(OUTDIR)\Dtaccess.pdb"
	-@erase ".\build\fr\da32stat\Dtaccess.exe"
	-@erase ".\build\fr\da32stat\Dtaccess.ilk"
	-@erase ".\build\fr\da32stat\link\dtaccess.res"
...
CPP_PROJ=/nologo /MDd /W3 /Gm /GX /ZI /Od /I "..\..\dapi\src\api" /D "_DEBUG" /D "ITALIAN" /D "WIN32" /D "_WINDOWS" /Fp"$(INTDIR)\Dtsample.pch" /YX /Fo"$(INTDIR)\\" /Fd"$(INTDIR)\\" /FD /c 
MTL_PROJ=/nologo /D "_DEBUG" /mktyplib203 /win32 
RSC_PROJ=/l 0x409 /fo".\build\fr\da32stat\link/dtaccess.res" /d "_DEBUG" 
BSC32=bscmake.exe
BSC32_FLAGS=/nologo /o".\build\fr\a32debug/Dtaccess.bsc" 
BSC32_SBRS= \
	
LINK32=link.exe
LINK32_FLAGS=..\..\dapi\build\dtstatic\it\debug\dtstatic.lib kernel32.lib user32.lib gdi32.lib winspool.lib comdlg32.lib advapi32.lib shell32.lib ole32.lib oleaut32.lib uuid.lib odbc32.lib odbccp32.lib winmm.lib msvcrt.lib /nologo /subsystem:windows /incremental:yes /pdb:"$(OUTDIR)\Dtaccess.pdb" /debug /machine:I386 /out:".\build\fr\da32stat/Dtaccess.exe" 
LINK32_OBJS= \
	"$(INTDIR)\dtsample.obj" \
	".\build\fr\da32stat\link\dtaccess.res"

".\build\fr\da32stat\Dtaccess.exe" : "$(OUTDIR)" $(DEF_FILE) $(LINK32_OBJS)
    $(LINK32) @<<
  $(LINK32_FLAGS) $(LINK32_OBJS)
<<
...
OUTDIR=.\build\it\a32stat
INTDIR=.\build\it\a32stat\link
# Begin Custom Macros
OutDir=.\build\it\a32stat
# End Custom Macros
...
CLEAN :
	...
	-@erase "$(INTDIR)\vc60.idb"
	-@erase "$(OUTDIR)\Dtaccess.exe"
	-@erase ".\build\fr\a32stat\link\dtaccess.res"
...
CPP_PROJ=/nologo /MT /W3 /GX /O2 /I "..\..\dapi\src\api" /D "NDEBUG" /D "FRENCH" /D "WIN32" /D "_WINDOWS" /Fp"$(INTDIR)\Dtsample.pch" /YX /Fo"$(INTDIR)\\" /Fd"$(INTDIR)\\" /FD /c 
MTL_PROJ=/nologo /D "NDEBUG" /mktyplib203 /win32 
RSC_PROJ=/l 0x409 /fo"build\fr\a32stat\link/dtaccess.res" /d "NDEBUG" 
BSC32=bscmake.exe
BSC32_FLAGS=/nologo /o".\build\fr\access32/Dtaccess.bsc" 
BSC32_SBRS= \
	
LINK32=link.exe
LINK32_FLAGS=..\..\dapi\build\dtstatic\it\release\dtstatic.lib kernel32.lib user32.lib gdi32.lib winspool.lib comdlg32.lib advapi32.lib shell32.lib ole32.lib oleaut32.lib uuid.lib odbc32.lib odbccp32.lib winmm.lib msvcrt.lib /nologo /subsystem:windows /pdb:none /machine:I386 /out:"$(OUTDIR)\Dtaccess.exe" 
LINK32_OBJS= \
	"$(INTDIR)\dtsample.obj" \
	".\build\fr\a32stat\link\dtaccess.res"
...
".\build\fr\da32stat\link\dtaccess.res" : $(SOURCE) "$(INTDIR)"
	$(RSC) $(RSC_PROJ) $(SOURCE)
...
".\build\fr\a32stat\link\dtaccess.res" : $(SOURCE) "$(INTDIR)"
	$(RSC) $(RSC_PROJ) $(SOURCE)
