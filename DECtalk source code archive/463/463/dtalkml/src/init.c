...
#include <sys/ipc.h>
#ifdef __QNX__
#include <sys/mman.h> // geb qnx  build fix this was "shm.h"
#else
#include <sys/shm.h>
#endif
#include <errno.h>
...
#if !defined __linux__ && !defined _SPARC_SOLARIS_ && !defined _APPLE_MAC_  && !defined __QNX__ /* we don't use this stuf in linux */
