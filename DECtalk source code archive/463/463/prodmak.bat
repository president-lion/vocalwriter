...
if /i "%dtlang%"=="ITALIAN" set lang_long= Italian"
if /i "%dtlang%"=="ITALIAN" set lang_conf= Italian
if /i "%dtlang%"=="ITALIAN" set lang_short=it
if /i "%dtlang%"=="ITALIAN" goto dtlangok
...
if "%lang_short%"=="it" goto skip_dtlkstat
...
if NOT exist ..\%bld_path%\dectalkvb\%lang_short%\release\dectalkvb.dll echo Workspace %blddrv%%bldpath%\dapi\src\dectalkvb.dsw for Win32 Release%lang_conf% not build >> %blddrv%%bldpath%\build_log\errors\win%index%.log
...
if "%lang_short%"=="it" goto skip_sapi3
if "%prodmak_debug%"=="1" pause
cd sapi\src
...
rem No Italian for sapi3 either (and never will be)
:skip_sapi3
...
if "%lang_short%"=="it" goto skip_ttstest
if "%prodmak_debug%"=="1" pause
rem ***************************************************************
...
if "%lang_short%"=="it" goto skip_wttstest
if "%prodmak_debug%"=="1" pause
cd wttstest
