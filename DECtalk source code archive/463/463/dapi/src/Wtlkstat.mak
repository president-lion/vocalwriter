...
CLEAN :
	...
	-@erase "$(INTDIR)\Ph_drwt02it.obj"
	-@erase "$(INTDIR)\Ph_drwt02it.sbr"
	-@erase "$(INTDIR)\ph_inton.obj"
	-@erase "$(INTDIR)\ph_inton.sbr"
	-@erase "$(INTDIR)\Ph_inton2.obj"
	-@erase "$(INTDIR)\Ph_inton2.sbr"
	-@erase "$(INTDIR)\Ph_inton2it.obj"
	-@erase "$(INTDIR)\Ph_inton2it.sbr"
	-@erase "$(INTDIR)\ph_main.obj"
...
BSC32_SBRS= \
	...
	"$(INTDIR)\Ttsapi.sbr" \
	"$(INTDIR)\Vtm.sbr" \
	"$(INTDIR)\Ph_inton2it.sbr" \
	"$(INTDIR)\Ph_drwt02it.sbr"
...
"$(INTDIR)\Ph_drwt02it.obj"	"$(INTDIR)\Ph_drwt02it.sbr" : $(SOURCE) "$(INTDIR)"
	$(CPP) $(CPP_PROJ) $(SOURCE)
...
"$(INTDIR)\Ph_inton2.obj"	"$(INTDIR)\Ph_inton2.sbr" : $(SOURCE) "$(INTDIR)"
	$(CPP) $(CPP_PROJ) $(SOURCE)
...
"$(INTDIR)\Ph_inton2it.obj"	"$(INTDIR)\Ph_inton2it.sbr" : $(SOURCE) "$(INTDIR)"
	$(CPP) $(CPP_PROJ) $(SOURCE)
