...
/* **** QNX bypass for linux audio definitions....
*/
#define SNDCTL_DSP_SAMPLESIZE      50
#define SNDCTL_DSP_STEREO	    1
#define SNDCTL_DSP_SPEED	    2
#define SNDCTL_DSP_GETCAPS	    3
#define SNDCTL_DSP_GETOSPACE	    4
#define SNDCTL_DSP_GETFMTS	    4
#define SNDCTL_DSP_RESET	    5
#define SNDCTL_DSP_SETFRAGMENT	    6
#define SNDCTL_DSP_CHANNELS	    1
#define SNDCTL_DSP_GETBLKSIZE	    7
#define AFMT_U8			    8
#define AFMT_S16_LE		    1
#define DSP_CAP_REALTIME	    2
#define DSP_CAP_BATCH		    3
#define DSP_CAP_TRIGGER		    4
#define DSP_CAP_MMAP		    5
#define SOUND_MIXER_READ_PCM	    1
#define SOUND_MIXER_WRITE_PCM 	    2


/* **** END:  QNX bypass for linux audio definitions....
*/
...
# ifdef GEB_DEBUG
#       define dprintf(dlevel, printfargs)  { if (dlevel <= GEB_DEBUG ) printf printfargs; }
#       define dfprintf(dlevel, printfargs)  { if (dlevel <= GEB_DEBUG ) fprintf printfargs; }
#       define dmsglog(dlevel, msglogargs) { if (dlevel <= GEB_DEBUG ) msglog msglogargs; }
#       define dtrace fprintf(stderr, "GEB-Trace %s@Line:%d\n",__FILE__, __LINE__)
#       define dtrint(var) fprintf(stderr, "GEB-Trace line %d var = %d\n", __LINE__, var)
# else /* GEB_DEBUG */
#       define dprintf(a,b)
#       define dfprintf(a,b)
#       define dmsglog(a,b)
