...
{
	pKsd_t->sprate = pKsd_t->sprate-18;
	pDph_t->timeref=5000/pKsd_t->sprate; //stressed timed langua
...
else if(pKsd_t->lang_curr == LANG_german)
{
		...
		pKsd_t->sprate = pKsd_t->sprate + 33;
}
