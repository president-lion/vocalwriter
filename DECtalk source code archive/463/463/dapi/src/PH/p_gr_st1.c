 ...
 *
 */
void gr_back_smooth_rules (LPTTS_HANDLE_T phTTS, short shrib, short feacur,
 ...
 *
 */
void gr_special_rules (LPTTS_HANDLE_T phTTS, short fealas,
...
groupings" */
		...
		if ((feanex & (FNASAL | FPLOSV)) IS_PLUS)
		{
			...
			{		/* yes they're both done in the same place*/
				bdur = 0;
			}
