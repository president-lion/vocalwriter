...
#include "dectalkf.h"
#include "ph_def.h"
const unsigned char           la_ascky_check[] =
{
...
#ifdef OS_PALM
const unsigned char          * la_common_affixes[] =
#else
const unsigned char          *const la_common_affixes[] =
#endif
{
	"mi'ento",
	0
...
const unsigned char           la_syl_vowels[] = "aeiouI";

#ifdef OS_PALM
const unsigned char          * la_syl_cons[] =
#else
const unsigned char          *const la_syl_cons[] =
#endif
{
...
void la_saysyllable (LPTTS_HANDLE_T phTTS) /* changed name from nsaysyllable MGS */
{
	int                     i;
	int                     last, old_tot;
