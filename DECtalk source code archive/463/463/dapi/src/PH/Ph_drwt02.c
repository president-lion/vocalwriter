...
void set_user_target(PDPH_T pDph_t,short *psF0command); 
void filter_commands(PDPH_T pDph_t,short f0in); 
void filter_seg_commands(PDPH_T pDph_t,short f0in);
void linear_interp(PDPH_T pDph_t); 
void set_tglst(PDPH_T pDph_t);
...
#else
const short *const fr_f0fsegtars = fr_f0msegtars;
#endif
/* Incremental changes to F0 caused by segmental influences */
#else // #ifndef HLSYN
...
#define SIMPLIFY
#ifdef SIMPLIFY ///try to get to a single baseline for multiple languagse
		/* DECLARATIVE*/
			...
			pDph_t->f0basetypes[4][10]=1080;
			pDph_t->f0basetypes[4][11]=1060;
			pDph_t->f0basetypes[4][12]=1040;
			pDph_t->f0basetypes[4][13]=1020;
			pDph_t->f0basetypes[4][14]=980;
			pDph_t->f0basetypes[4][15]=960;
			pDph_t->f0basetypes[4][16]=950;
			...
			pDph_t->f0basetypes[1][15]=1124;
			pDph_t->f0basetypes[1][16]=1040;
			
			/*exclamation*/
			pDph_t->f0basetypes[2][0]=1057+50;
			pDph_t->f0basetypes[2][1]=1085+50;
			pDph_t->f0basetypes[2][2]=1109+50;
			pDph_t->f0basetypes[2][3]=1117+50;
			pDph_t->f0basetypes[2][4]=1113+50;
			pDph_t->f0basetypes[2][5]=1149+50;
			pDph_t->f0basetypes[2][6]=1095+50;
			pDph_t->f0basetypes[2][7]=1082+50;
			pDph_t->f0basetypes[2][8]=1079+50;
			pDph_t->f0basetypes[2][9]=1065+50;
			pDph_t->f0basetypes[2][10]=1053+50;
			pDph_t->f0basetypes[2][11]=1040+50;
			pDph_t->f0basetypes[2][12]=1038+50;
			pDph_t->f0basetypes[2][13]=1024+50;
			pDph_t->f0basetypes[2][14]=980+50;
			pDph_t->f0basetypes[2][15]=852+50;
			pDph_t->f0basetypes[2][16]=843+50;
...
if(!(pKsd_t->modeflag & MODE_READING))
...
else
{
	...
	else
	{
			pDphsettar->tarimp = pDphsettar->f0command;
					...
					pDphsettar->delimp = 0;
					pDphsettar->nimp = pDphsettar->length-((pDph_t->f0_lp_filter-1300)>>8);
#else
...
if (pKsd_t->lang_curr == LANG_british)
{
		...
		if(pDphsettar->nframb << 4 >= pDphsettar->basetime )
		{
			if (pKsd_t->lang_curr == LANG_british)
			{
				//adjustment for no hat_rise
				pDphsettar->basestep=(pDphsettar->lastbase>>2)-(pDph_t->f0baseline[pDphsettar->basecntr+1]+180);
			}
			else
			{
	...
	if(pKsd_t->lang_curr == LANG_british)
	{
			...
			if(pDphsettar->glide_inc > 0 )
			{
				...
				//		WINprintf("maleseg f0s %d tarseg %d tarseg1 %d \n", pDph_t->f0s,pDphsettar->tarseg,pDphsettar->tarseg1); 
				 ...
				 //WINprintf (" f0 %d f0segtars %d f0prime %d \n ",
		...
		*    the nominal average pitch of Paul's voice (AP in spdef)  */
		...
		if (pDph_t->f0mode< SINGING) {
				...
				pDph_t->f0prime = pDph_t->f0minimum	+ frac4mul((pDph_t->f0prime - 1300), pDph_t->f0scalefac);
...
else
{
	if (pDph_t->nf0ev <= -2) 
	{
		...
		pDph_t->f0basetypes[0][12]=1748; 
		pDph_t->f0basetypes[0][13]=1734; 
		pDph_t->f0basetypes[0][14]=1720; 
		pDph_t->f0basetypes[0][15]=1714; 
		pDph_t->f0basetypes[0][16]=1708;
	...
	pDph_t->f0basetypes[2][0]=1887; 
		...
		pDph_t->f0basetypes[2][6]=1795; 
		pDph_t->f0basetypes[2][7]=1782; 
		pDph_t->f0basetypes[2][8]=1779; 
		pDph_t->f0basetypes[2][9]=1765; 
		pDph_t->f0basetypes[2][10]=1763; 
		pDph_t->f0basetypes[2][11]=1750; 
		pDph_t->f0basetypes[2][12]=1748; 
		pDph_t->f0basetypes[2][13]=1734; 
		pDph_t->f0basetypes[2][14]=1720; 
		pDph_t->f0basetypes[2][15]=1714; 
		pDph_t->f0basetypes[2][16]=1708; 
		...
		pDph_t->f0basetypes[3][6]=1795; 
		pDph_t->f0basetypes[3][7]=1782; 
		pDph_t->f0basetypes[3][8]=1779; 
		pDph_t->f0basetypes[3][9]=1765; 
		pDph_t->f0basetypes[3][10]=1763; 
		pDph_t->f0basetypes[3][11]=1750; 
		pDph_t->f0basetypes[3][12]=1748; 
		pDph_t->f0basetypes[3][13]=1734; 
		pDph_t->f0basetypes[3][14]=1720; 
		pDph_t->f0basetypes[3][15]=1714; 
		pDph_t->f0basetypes[3][16]=1708;
		...
		*/
		...
		pDph_t->f0basetypes[0][1]=1627; 
		pDph_t->f0basetypes[0][2]=1609; 
		pDph_t->f0basetypes[0][3]=1687; 
		pDph_t->f0basetypes[0][4]=1663; 
		pDph_t->f0basetypes[0][5]=1649; 
		pDph_t->f0basetypes[0][6]=1625; 
		pDph_t->f0basetypes[0][7]=1602; 
		pDph_t->f0basetypes[0][8]=1689; 
		pDph_t->f0basetypes[0][9]=1665; 
		pDph_t->f0basetypes[0][10]=1643; 
		pDph_t->f0basetypes[0][11]=1620; 
		pDph_t->f0basetypes[0][12]=1608; 
		pDph_t->f0basetypes[0][13]=1604; 
		pDph_t->f0basetypes[0][14]=1600; 
		pDph_t->f0basetypes[0][15]=1654; 
		pDph_t->f0basetypes[0][16]=1558; 
		...
		pDph_t->f0basetypes[1][6]=1685; 
		pDph_t->f0basetypes[1][7]=1662; 
		pDph_t->f0basetypes[1][8]=1649; 
		pDph_t->f0basetypes[1][9]=1625; 
		pDph_t->f0basetypes[1][10]=1603; 
		pDph_t->f0basetypes[1][11]=1610; 
		pDph_t->f0basetypes[1][12]=1618; 
		pDph_t->f0basetypes[1][13]=1664; 
		pDph_t->f0basetypes[1][14]=1680; 
		pDph_t->f0basetypes[1][15]=1684; 
		pDph_t->f0basetypes[1][16]=1788; 
		...
		pDph_t->f0basetypes[2][4]=1813; 
		pDph_t->f0basetypes[2][5]=1809; 
		pDph_t->f0basetypes[2][6]=1885; 
		pDph_t->f0basetypes[2][7]=1862; 
		pDph_t->f0basetypes[2][8]=1849; 
		pDph_t->f0basetypes[2][9]=1825; 
		pDph_t->f0basetypes[2][10]=1806; 
		pDph_t->f0basetypes[2][11]=1786; 
		pDph_t->f0basetypes[2][12]=1756; 
		pDph_t->f0basetypes[2][13]=1734; 
		pDph_t->f0basetypes[2][14]=1760; 
		pDph_t->f0basetypes[2][15]=1704; 
		pDph_t->f0basetypes[2][16]=1758; 
		
		/*question*/
		pDph_t->f0basetypes[3][0]=1687; 
		pDph_t->f0basetypes[3][1]=1665; 
		pDph_t->f0basetypes[3][2]=1639; 
		pDph_t->f0basetypes[3][3]=1627; 
		pDph_t->f0basetypes[3][4]=1613; 
		pDph_t->f0basetypes[3][5]=1609; 
		pDph_t->f0basetypes[3][6]=1685; 
		pDph_t->f0basetypes[3][7]=1662; 
		pDph_t->f0basetypes[3][8]=1649; 
		pDph_t->f0basetypes[3][9]=1625; 
		pDph_t->f0basetypes[3][10]=1603; 
		pDph_t->f0basetypes[3][11]=1680; 
		pDph_t->f0basetypes[3][12]=1668; 
		pDph_t->f0basetypes[3][13]=1744; 
		pDph_t->f0basetypes[3][14]=1760; 
		pDph_t->f0basetypes[3][15]=1674; 
		pDph_t->f0basetypes[3][16]=1718; 
		
		
		/* short phrase */	
		pDph_t->f0basetypes[4][0]=1687; 
		pDph_t->f0basetypes[4][1]=1627; 
		pDph_t->f0basetypes[4][2]=1609; 
		pDph_t->f0basetypes[4][3]=1587; 
		pDph_t->f0basetypes[4][4]=1563; 
		pDph_t->f0basetypes[4][5]=1549; 
		pDph_t->f0basetypes[4][6]=1525; 
		pDph_t->f0basetypes[4][7]=1502; 
		pDph_t->f0basetypes[4][8]=1489; 
		pDph_t->f0basetypes[4][9]=1465; 
		pDph_t->f0basetypes[4][10]=1443; 
		pDph_t->f0basetypes[4][11]=1420; 
		pDph_t->f0basetypes[4][12]=1408; 
		pDph_t->f0basetypes[4][13]=1384; 
		pDph_t->f0basetypes[4][14]=1360; 
		pDph_t->f0basetypes[4][15]=1344; 
		pDph_t->f0basetypes[4][16]=1328; 
...
if (pKsd_t->lang_curr == LANG_british)
{
		...
		if(pDphsettar->nframb<<4 >= pDphsettar->basetime)
		{
			...
			{
				//adjustment for no hat_rise
				pDphsettar->basestep=(pDphsettar->lastbase>>2)-(pDph_t->f0baseline[pDphsettar->basecntr+1]+250);
			}
			else
			{
				pDphsettar->basestep=(pDphsettar->lastbase>>2)-pDph_t->f0baseline[pDphsettar->basecntr+1];
        ...
        if ((pDphsettar->nframs >= (pDphsettar->segdur + pDphsettar->extrad)) 
			...
			{
                f0seg = 0;//fr_f0fsegtars[pDphsettar->phocur & PVALUE];
			}
			// f0seg = pDph_t->gl_phones[pDph_t->gl_lang][pDph_t->gl_group].phonames[phocur].f0segtars;
...
if (pKsd_t->lang_curr == LANG_british)
{
		...
		*    the nominal average pitch of Paul's voice (AP in spdef)  */
		if (pDph_t->f0mode< SINGING) {
			if(pDph_t->clausetype == 2)
			{
				pDph_t->f0prime = pDph_t->f0minimum	+ frac4mul((pDph_t->f0prime - 2100), pDph_t->f0scalefac+500);
				
			}
			else
			{
				pDph_t->f0prime = pDph_t->f0minimum	+ frac4mul((pDph_t->f0prime - 2100), pDph_t->f0scalefac);
			}
		}
	...
	if (pDphsettar->nframg >= pDphsettar->segdrg) {
		...
		if (((phone_feature( pDph_t,pDph_t->allophons[pDphsettar->npg+1]) & FVOWEL) IS_PLUS)
			...
			//eab helpme imdying
				...
				&& ((pDph_t->allofeats[pDphsettar->npg+1] & FSTRESS_1) IS_PLUS) 
				 && ((phone_feature( pDph_t,pDph_t->allophons[pDphsettar->npg+1]) & FNASAL) IS_MINUS)) {
				pDphsettar->tglstn = pDphsettar->segdrg;
			}
		}
