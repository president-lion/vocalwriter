...

{
	...
	memset(GetGlobalDTPtr()->Dph_t,0,sizeof(DPH_T));
	memset(GetGlobalDTPtr()->STphsettar,0,sizeof(DPHSETTAR_ST));
	phTTS->pPHThreadData = GetGlobalDTPtr()->Dph_t;
	pDph_t = phTTS->pPHThreadData;
	pDph_t->pSTphsettar = GetGlobalDTPtr()->STphsettar;
	pDphsettar_st = pDph_t->pSTphsettar;
#endif //OS_SYMBIAN
#endif
...
SetEvent (phTTS->hMallocSuccessEvent);	/* Malloc s are success,set the event */
	...
	// CAB Removed warnings by typecast
	pDph_t->voidef[0] = (short*)fr_paul;
	pDph_t->voidef[1] = (short*)fr_betty;
	pDph_t->voidef[2] = (short*)fr_harry;
	pDph_t->voidef[3] = (short*)fr_frank;
	pDph_t->voidef[4] = (short*)fr_dennis;
	pDph_t->voidef[5] = (short*)fr_kit;
	pDph_t->voidef[6] = (short*)fr_ursula;
	pDph_t->voidef[7] = (short*)fr_rita;
	pDph_t->voidef[8] = (short*)fr_wendy;
	...
	// CAB Removed warnings by typecast
	pDph_t->voidef[0] = (short*)us_paul;
	pDph_t->voidef[1] = (short*)us_betty;
	pDph_t->voidef[2] = (short*)us_harry;
	pDph_t->voidef[3] = (short*)us_frank;
	pDph_t->voidef[4] = (short*)us_dennis;
	pDph_t->voidef[5] = (short*)us_kit;
	pDph_t->voidef[6] = (short*)us_ursula;
	pDph_t->voidef[7] = (short*)us_rita;
	pDph_t->voidef[8] = (short*)us_wendy;
	pDph_t->voidef[9] = pDph_t->var_val;
	}
