...
const unsigned char           sp_ascky_check[] =
{
...
#ifdef OS_PALM
const unsigned char          * sp_common_affixes[] =
#else
const unsigned char          *const sp_common_affixes[] =
#endif
{
	"mi'ento",
	0
...
const unsigned char           sp_syl_vowels[] = "aeiouI";

#ifdef OS_PALM
const unsigned char          * sp_syl_cons[] =
#else
const unsigned char          *const sp_syl_cons[] =
#endif
{
...
void sp_saysyllable (LPTTS_HANDLE_T phTTS) /* changed name from nsaysyllable MGS */
{
	int                     i;
	int                     last, old_tot;
