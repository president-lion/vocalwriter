...
/*I */ {  0, 0, 0, 0, 0, 0, 0,63, 0, 330,2500,2900,290,150,130,200 },//I 
...
#else
/*An*/ {  0, 0, 0, 0, 0, 0,50,64, 8, 690, 1000,2845,340,100,180,250 },//An
/*In*/ {  0, 0, 0, 0, 0, 0,45,64, 8, 740,1500,2750,340,300,100,250 },//In
/*On*/ {  0, 0, 0, 0, 0, 0,40,65, 8, 430, 1000,2340,350,200,100,200 },//On
/*Un*/ {  0, 0, 0, 0, 0, 0,55,64, 8, 640,1440,2370,340,260,100,200 },//Un

#endif
/*Ap*/ {  0, 0, 0, 0, 0, 0, 50,35,20, 430,1500,2500,290,120, 60,120 },//Ap
...
/*V */ {  0, 0, 0, 0, 0, 0, 0,43, 7, 280,1400,2480,290,100,120,120 },//V 
/*Z */ {  0, 0, 0, 0, 0, 0, 0,43, 7, 280,1620,2600,290,100,140,300 },//Z 
/*B */ {  0, 0, 0, 0, 0, 0, 0,30,40, 210,1100,2150,290, 90, 80,130 },//B 
/*D */ {  0, 0, 0, 0, 0, 0, 0,30,40, 210,1600,2600,290, 90,100,240 },//D 
/*G */ {  0, 0, 0, 0, 0, 0, 0,30,40, 380,1790,2520,290, 90,120,180 },//G 
/*K */ {  0, 0, 0, 0, 0, 0, 0, 0, 7, 380,1790,2250,290,200,160,280 },//K 
/*P */ {  0, 0, 0, 0, 0, 0, 0, 0, 7, 200,1370,2050,290,200,180,250 },//P 
/*T */ {  0, 0, 0, 0, 0, 0, 0, 0, 7, 350,1700,2700,290,200,150,250 },//T 
/*Gn*/ {  0, 0, 0, 0, 0, 0, 0,52, 16, 330,2350,2650,400,100,200,380 },//Gn
/*M */ {  0, 0, 0, 0, 0, 0, 0,60, 16, 300,1200,2400,400,130,300,130 },//M 
/*N */ {  0, 0, 0, 0, 0, 0, 0,60, 16, 300,1600,2800,400,200,200,200 },//N 
/*Ng*/ {  0, 0, 0, 0, 0, 0, 0,60, 16, 380,1540,2250,400,160,150,100 } //Ng
...
/*fW */ {  0, 0, 0, 0, 0, 0, 0,62, 6, 280, 700,2800,290, 90, 100,350 },/*W */
/*fWu*/ {  0, 0, 0, 0, 0, 0, 0,63, 6, 330,1550,2150,290, 90, 100, 60 },/*Wu*/
/*fY */ {  0, 0, 0, 0, 0, 0, 0,56, 6, 330,2470,2770,290, 90,200,300 },/*Y */
...
#else
/*fM */ {  0, 0, 0, 0, 0, 0, 0,61,12, 250,1300,2620,400,130,280,360 },/*M */
/*fN */ {  0, 0, 0, 0, 0, 0, 0,60,12, 430,1640,2500,400,130,300,460 },/*N */
...
const short fr_maleloc[] = {
  ...
  320,54,55,   1950,15,50,   2750, 19,50,  // 271 : Ch front
  320,54,55,   1680,10,50,   2000, 10,50,  // 280 : Ch back-unrounded
  320,54,55,   1680,10,55,   2350, 10,70, // 289 : Ch rounded

  240,32,55,   1750,15,50,   2750, 19,50,  // 298 : J front
  245,32,55,   1580,20,50,   2450, 10,50,  // 307 : J back-unrounded
  245,32,55,   1680,10,55,   2350, 10,70, // 316 : J rounded
#ifdef HLSYN

  370,30,30,   1200,10,25,   2000, 30,40,  // 325 : M front
  350,20,30,   1,88,25,   1550, 80,25,  // 334 : M back et rounded

  350,20,35,   1300,70,50,   2800, 25,65,  // 343 : N front
  350,20,30,   1300,25,45,   2600,  0,60,  // 352 : N back-unrounded
  350,20,30,   1300,30,95,   2820,  0,95,  // 361 : N rounded
...
const short fr_femloc[] = {
  ...
  320,54,55,     1950,25,50,   2750,19,70,  /* Ch front */
  320,54,55,     1680,10,50,   2450,10,70,  /* Ch back-unrounded */
  320,54,55,     1680,10,70,   2350,10,100, /* Ch rounded */
 
  240,32,55,     1750,25,50,   2750,19,70,  /* J front */
  245,32,55,     1680,10,50,   2450,10,70,  /* J back-unrounded */
  245,32,55,     1680,10,70,   2350,10,100, /* J rounded */
...
const short fr_malamp[] = {
 ...
 30, 35, 45, 40, 40,  0,  // J front; indice 265
 30, 35, 45, 40, 40,  0,  // J back
 30, 35, 40, 40, 40,  0,  // J round
 30, 35, 40, 40, 40,  0,  // J nonsonor
};
