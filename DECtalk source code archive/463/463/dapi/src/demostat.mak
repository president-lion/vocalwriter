...
!MESSAGE "demostat - Win32 Release Italian" (based on "Win32 (x86) Static Library")
!MESSAGE 
...
!ELSEIF  "$(CFG)" == "demostat - Win32 Release Italian"

OUTDIR=.\..\build\demostat\it\release
INTDIR=.\..\build\demostat\it\release\link
# Begin Custom Macros
OutDir=.\..\build\demostat\it\release
# End Custom Macros
...
CPP_PROJ=/nologo /MT /W3 /GX /O2 /I ".\api" /I ".\acna" /I ".\lts" /I ".\vtm" /I ".\ph" /I ".\kernel" /I ".\nt" /I ".\cmd" /I ".\include" /I ".\protos" /I "..\.." /D "NDEBUG" /D "WIN32" /D "_WINDOWS" /D "BLD_DECTALK_DLL" /D "ITALIAN" /Fp"$(INTDIR)\demostat.pch" /YX /Fo"$(INTDIR)\\" /Fd"$(INTDIR)\\" /FD /Zm200 /c 
BSC32=bscmake.exe
BSC32_FLAGS=/nologo /o"$(OUTDIR)\demostat.bsc" 
BSC32_SBRS= \
