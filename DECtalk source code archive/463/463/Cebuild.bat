...
nmake /NOLOGO /f "Dtsample.vcn" CFG="Dtsample - Win32 (WCE x86em) Release Italian" CESubsystem=windowsce,2.0 CEVersion=211 CEConfigName="H/PC Pro 2.11"
if NOT exist .\%build_static%\x86em\it\release\dtsample.exe echo Workspace %blddrv%%bldpath%\samplece\dtsample\dtsample.vcn wce211 Pro Win32 (WCE X86EM) Release Italian not build >> %blddrv%%bldpath%\build_log\errors\win_ce%index%.log
:wce211_pro_dtsample_x86em_ce

rem if "%bug_x86em_cedll%"=="1" goto wce211_pro_dtsample_x86em_cedll
...
nmake /NOLOGO /f "Dtsample.vcn" CFG="Dtsample - Win32 (WCE x86em) Release Italian Dll" CESubsystem=windowsce,2.0 CEVersion=211 CEConfigName="H/PC Pro 2.11"
if NOT exist .\%build_dll%\x86em\it\release\dtsample.exe echo Workspace %blddrv%%bldpath%\samplece\dtsample\dtsample.vcn wce211 Pro Win32 (WCE X86EM) Release Italian Dll not build >> %blddrv%%bldpath%\build_log\errors\win_ce%index%.log
...
rem if "%bug_arm_ce%"=="1" goto wce211_pro_cetalk_arm_ce
...
nmake /NOLOGO /f "CEtalk.vcn" CFG="CEtalk - Win32 (WCE ARM) Release Italian" CESubsystem=windowsce,2.0 CEVersion=211 CEConfigName="H/PC Pro 2.11"
if NOT exist .\%build_static%\arm\it\release\dtalk_it.exe echo Workspace %blddrv%%bldpath%\samplece\cetalk\cetalk.vcn wce211 Pro Win32 (WCE ARM) Release Italian not build >> %blddrv%%bldpath%\build_log\errors\win_ce%index%.log
:wce211_pro_cetalk_arm_ce

rem if "%bug_arm_cedll%"=="1" goto wce211_pro_cetalk_arm_cedll
...
nmake /NOLOGO /f "CEtalk.vcn" CFG="CEtalk - Win32 (WCE ARM) Release Italian dll" CESubsystem=windowsce,2.0 CEVersion=211 CEConfigName="H/PC Pro 2.11"
if NOT exist .\%build_dll%\arm\it\release\dtalk_it.exe echo Workspace %blddrv%%bldpath%\samplece\cetalk\cetalk.vcn wce211 Pro Win32 (WCE ARM) Release Italian Dll not build >> %blddrv%%bldpath%\build_log\errors\win_ce%index%.log
:wce211_pro_cetalk_arm_cedll

set LIB=%DEVROOT%\%PLATFORM%\MS HPC PRO\lib\MIPS;%DEVROOT%\%PLATFORM%\MS HPC PRO\mfc\lib\MIPS;

rem if "%bug_mips_ce%"=="1" goto wce211_pro_cetalk_mips_ce
...
nmake /NOLOGO /f "CEtalk.vcn" CFG="CEtalk - Win32 (WCE MIPS) Release Italian" CESubsystem=windowsce,2.0 CEVersion=211 CEConfigName="H/PC Pro 2.11"
if NOT exist .\%build_static%\mips\it\release\dtalk_it.exe echo Workspace %blddrv%%bldpath%\samplece\cetalk\cetalk.vcn wce211 Pro Win32 (WCE MIPS) Release Italian not build >> %blddrv%%bldpath%\build_log\errors\win_ce%index%.log
:wce211_pro_cetalk_mips_ce

rem if "%bug_mips_cedll%"=="1" goto wce211_pro_cetalk_mips_cedll
...
nmake /NOLOGO /f "CEtalk.vcn" CFG="CEtalk - Win32 (WCE MIPS) Release Italian dll" CESubsystem=windowsce,2.0 CEVersion=211 CEConfigName="H/PC Pro 2.11"
if NOT exist .\%build_dll%\mips\it\release\dtalk_it.exe echo Workspace %blddrv%%bldpath%\samplece\cetalk\cetalk.vcn wce211 Pro Win32 (WCE MIPS) Release Italian Dll not build >> %blddrv%%bldpath%\build_log\errors\win_ce%index%.log
:wce211_pro_cetalk_mips_cedll

set LIB=%DEVROOT%\%PLATFORM%\MS HPC PRO\lib\SH3;%DEVROOT%\%PLATFORM%\MS HPC PRO\mfc\lib\SH3;

rem if "%bug_sh_ce%"=="1" goto wce211_pro_cetalk_sh_ce
...
nmake /NOLOGO /f "CEtalk.vcn" CFG="CEtalk - Win32 (WCE SH3) Release Italian" CESubsystem=windowsce,2.0 CEVersion=211 CEConfigName="H/PC Pro 2.11"
if NOT exist .\%build_static%\sh\it\release\dtalk_it.exe echo Workspace %blddrv%%bldpath%\samplece\cetalk\cetalk.vcn wce211 Pro Win32 (WCE SH3) Release Italian not build >> %blddrv%%bldpath%\build_log\errors\win_ce%index%.log
:wce211_pro_cetalk_sh_ce

rem if "%bug_sh_cedll%"=="1" goto wce211_pro_cetalk_sh_cedll
...
nmake /NOLOGO /f "CEtalk.vcn" CFG="CEtalk - Win32 (WCE SH3) Release Italian dll" CESubsystem=windowsce,2.0 CEVersion=211 CEConfigName="H/PC Pro 2.11"
if NOT exist .\%build_dll%\sh\it\release\dtalk_it.exe echo Workspace %blddrv%%bldpath%\samplece\cetalk\cetalk.vcn wce211 Pro Win32 (WCE SH3) Release Italian Dll not build >> %blddrv%%bldpath%\build_log\errors\win_ce%index%.log
:wce211_pro_cetalk_sh_cedll

set LIB=%DEVROOT%\%PLATFORM%\MS HPC PRO\lib\SH4;%DEVROOT%\%PLATFORM%\MS HPC PRO\mfc\lib\SH4;

rem if "%bug_sh4_ce%"=="1" goto wce211_pro_cetalk_sh4_ce
...
nmake /NOLOGO /f "CEtalk.vcn" CFG="CEtalk - Win32 (WCE SH4) Release Italian" CESubsystem=windowsce,2.0 CEVersion=211 CEConfigName="H/PC Pro 2.11"
if NOT exist .\%build_static%\sh4\it\release\dtalk_it.exe echo Workspace %blddrv%%bldpath%\samplece\cetalk\cetalk.vcn wce211 Pro Win32 (WCE SH4) Release Italian not build >> %blddrv%%bldpath%\build_log\errors\win_ce%index%.log
:wce211_pro_cetalk_sh4_ce

rem if "%bug_sh4_cedll%"=="1" goto wce211_pro_cetalk_sh4_cedll
...
nmake /NOLOGO /f "CEtalk.vcn" CFG="CEtalk - Win32 (WCE SH4) Release Italian dll" CESubsystem=windowsce,2.0 CEVersion=211 CEConfigName="H/PC Pro 2.11"
if NOT exist .\%build_dll%\sh4\it\release\dtalk_it.exe echo Workspace %blddrv%%bldpath%\samplece\cetalk\cetalk.vcn wce211 Pro Win32 (WCE SH4) Release Italian Dll not build >> %blddrv%%bldpath%\build_log\errors\win_ce%index%.log
:wce211_pro_cetalk_sh4_cedll

set LIB=%DEVROOT%\%PLATFORM%\MS HPC PRO\lib\X86em;%DEVROOT%\%PLATFORM%\MS HPC PRO\mfc\lib\X86em;

rem if "%bug_x86em_ce%"=="1" goto wce211_pro_cetalk_x86em_ce
...
nmake /NOLOGO /f "CEtalk.vcn" CFG="CEtalk - Win32 (WCE x86em) Release Italian" CESubsystem=windowsce,2.0 CEVersion=211 CEConfigName="H/PC Pro 2.11"
if NOT exist .\%build_static%\x86em\it\release\dtalk_it.exe echo Workspace %blddrv%%bldpath%\samplece\cetalk\cetalk.vcn wce211 Pro Win32 (WCE X86EM) Release Italian not build >> %blddrv%%bldpath%\build_log\errors\win_ce%index%.log
:wce211_pro_cetalk_x86em_ce

rem if "%bug_x86em_cedll%"=="1" goto wce211_pro_cetalk_x86em_cedll
...
nmake /NOLOGO /f "CEtalk.vcn" CFG="CEtalk - Win32 (WCE x86em) Release Italian dll" CESubsystem=windowsce,2.0 CEVersion=211 CEConfigName="H/PC Pro 2.11"
if NOT exist .\%build_dll%\x86em\it\release\dtalk_it.exe echo Workspace %blddrv%%bldpath%\samplece\cetalk\cetalk.vcn wce211 Pro Win32 (WCE X86EM) Release Italian Dll not build >> %blddrv%%bldpath%\build_log\errors\win_ce%index%.log
...
rem if "%bug_arm_ce%"=="1" goto wce211_pro_mailread_arm_ce
...
rem if "%bug_arm_cedll%"=="1" goto wce211_pro_mailread_arm_cedll
...
rem if "%bug_mips_ce%"=="1" goto wce211_pro_mailread_mips_ce
...
rem if "%bug_mips_cedll%"=="1" goto wce211_pro_mailread_mips_cedll
...
rem if "%bug_sh_ce%"=="1" goto wce211_pro_mailread_sh_ce
...
rem if "%bug_sh_cedll%"=="1" goto wce211_pro_mailread_sh_cedll
...
rem if "%bug_sh4_ce%"=="1" goto wce211_pro_mailread_sh4_ce
...
rem if "%bug_sh4_cedll%"=="1" goto wce211_pro_mailread_sh4_cedll
...
rem if "%bug_x86em_ce%"=="1" goto wce211_pro_mailread_x86em_ce
...
rem if "%bug_x86em_cedll%"=="1" goto wce211_pro_mailread_x86em_cedll
...
rem nmake /NOLOGO /f "windic.vcn" CFG="windic - Win32 (WCE ARM) Release Italian" CESubsystem=windowsce,2.0 CEVersion=211 CEConfigName="H/PC Pro 2.11"
rem if NOT exist .\%build_static%\arm\it\release\windic.exe echo Workspace %blddrv%%bldpath%\samplece\windic\windic.vcn wce211 Pro Win32 (WCE ARM) Release Italian not build >> %blddrv%%bldpath%\build_log\errors\win_ce%index%.log
...
rem if NOT exist .\%build_dll%\arm\us\release\windic.exe echo Workspace %blddrv%%bldpath%\samplece\windic\windic.vcn wce211 Pro Win32 (WCE ARM) Release Dll not build >> %blddrv%%bldpath%\build_log\errors\win_ce%index%.log
rem nmake /NOLOGO /f "windic.vcn" CFG="windic - Win32 (WCE ARM) Release Italian DLL" CESubsystem=windowsce,2.0 CEVersion=211 CEConfigName="H/PC Pro 2.11"
rem if NOT exist .\%build_dll%\arm\us\release\windic.exe echo Workspace %blddrv%%bldpath%\samplece\windic\windic.vcn wce211 Pro Win32 (WCE ARM) Release Dll not build >> %blddrv%%bldpath%\build_log\errors\win_ce%index%.log
...
rem nmake /NOLOGO /f "windic.vcn" CFG="windic - Win32 (WCE MIPS) Release Italian" CESubsystem=windowsce,2.0 CEVersion=211 CEConfigName="H/PC Pro 2.11"
rem if NOT exist .\%build_static%\mips\it\release\windic.exe echo Workspace %blddrv%%bldpath%\samplece\windic\windic.vcn wce211 Pro Win32 (WCE MIPS) Release Italian not build >> %blddrv%%bldpath%\build_log\errors\win_ce%index%.log
...
rem nmake /NOLOGO /f "windic.vcn" CFG="windic - Win32 (WCE MIPS) Release Italian DLL" CESubsystem=windowsce,2.0 CEVersion=211 CEConfigName="H/PC Pro 2.11"
rem if NOT exist .\%build_dll%\mips\it\release\windic.exe echo Workspace %blddrv%%bldpath%\samplece\windic\windic.vcn wce211 Pro Win32 (WCE MIPS) Release Italian Dll not build >> %blddrv%%bldpath%\build_log\errors\win_ce%index%.log
...
rem nmake /NOLOGO /f "windic.vcn" CFG="windic - Win32 (WCE SH3) Release Italian" CESubsystem=windowsce,2.0 CEVersion=211 CEConfigName="H/PC Pro 2.11"
rem if NOT exist .\%build_static%\sh\it\release\windic.exe echo Workspace %blddrv%%bldpath%\samplece\windic\windic.vcn wce211 Pro Win32 (WCE SH3) Release Italian not build >> %blddrv%%bldpath%\build_log\errors\win_ce%index%.log
...
rem nmake /NOLOGO /f "windic.vcn" CFG="windic - Win32 (WCE SH3) Release Italian DLL" CESubsystem=windowsce,2.0 CEVersion=211 CEConfigName="H/PC Pro 2.11"
rem if NOT exist .\%build_dll%\sh\it\release\windic.exe echo Workspace %blddrv%%bldpath%\samplece\windic\windic.vcn wce211 Pro Win32 (WCE SH3) Release Italian Dll not build >> %blddrv%%bldpath%\build_log\errors\win_ce%index%.log
...
rem nmake /NOLOGO /f "windic.vcn" CFG="windic - Win32 (WCE SH4) Release Italian" CESubsystem=windowsce,2.0 CEVersion=211 CEConfigName="H/PC Pro 2.11"
rem if NOT exist .\%build_static%\sh4\it\release\windic.exe echo Workspace %blddrv%%bldpath%\samplece\windic\windic.vcn wce211 Pro Win32 (WCE SH4 Release Italian not build >> %blddrv%%bldpath%\build_log\errors\win_ce%index%.log
...
rem nmake /NOLOGO /f "windic.vcn" CFG="windic - Win32 (WCE SH4) Release Italian DLL" CESubsystem=windowsce,2.0 CEVersion=211 CEConfigName="H/PC Pro 2.11"
rem if NOT exist .\%build_dll%\sh4\it\release\windic.exe echo Workspace %blddrv%%bldpath%\samplece\windic\windic.vcn wce211 Pro Win32 (WCE SH4) Release Italian Dll not build >> %blddrv%%bldpath%\build_log\errors\win_ce%index%.log
...
rem nmake /NOLOGO /f "windic.vcn" CFG="windic - Win32 (WCE x86em) Release Italian" CESubsystem=windowsce,2.0 CEVersion=211 CEConfigName="H/PC Pro 2.11"
rem if NOT exist .\%build_static%\x86em\it\release\windic.exe echo Workspace %blddrv%%bldpath%\samplece\windic\windic.vcn wce211 Pro Win32 (WCE X86EM) Release Italian not build >> %blddrv%%bldpath%\build_log\errors\win_ce%index%.log
...
rem nmake /NOLOGO /f "windic.vcn" CFG="windic - Win32 (WCE x86em) Release Italian DLL" CESubsystem=windowsce,2.0 CEVersion=211 CEConfigName="H/PC Pro 2.11"
rem if NOT exist .\%build_dll%\x86em\it\release\windic.exe echo Workspace %blddrv%%bldpath%\samplece\windic\windic.vcn wce211 Pro Win32 (WCE X86EM) Release Italian Dll not build >> %blddrv%%bldpath%\build_log\errors\win_ce%index%.log
...
if NOT exist ..\%build_wce_static%\mips\gr\release\dtstatic.lib set bug_mips_ce=1
nmake /NOLOGO /f "ce.vcn" CFG="CE - Win32 (WCE MIPS) Release Italian" CESubsystem=windowsce,2.0 CEVersion=211 CEConfigName="Pocket PC"
if NOT exist ..\%build_wce_static%\mips\it\release\dtstatic.lib echo Workspace %blddrv%%bldpath%\dapi\src\ce.vcn wce211 Palm Win32 (WCE MIPS) Release Italian not build >> %blddrv%%bldpath%\build_log\errors\win_ce%index%.log
if NOT exist ..\%build_wce_static%\mips\it\release\dtstatic.lib set bug_mips_ce=1
...
if NOT exist ..\%build_wce_dll%\mips\gr\release\dectalk.dll set bug_mips_cedll=1
nmake /NOLOGO /f "cedll.vcn" CFG="cedll - Win32 (WCE MIPS) Release Italian" CESubsystem=windowsce,2.0 CEVersion=211 CEConfigName="Pocket PC"
if NOT exist ..\%build_wce_dll%\mips\it\release\dectalk.dll echo Workspace %blddrv%%bldpath%\dapi\src\cedll.vcn wce211 Palm Win32 (WCE MIPS) Release Italian not build >> %blddrv%%bldpath%\build_log\errors\win_ce%index%.log
if NOT exist ..\%build_wce_dll%\mips\it\release\dectalk.dll set bug_mips_cedll=1
...
if NOT exist ..\%build_wce_static%\sh\gr\release\dtstatic.lib set bug_sh_ce=1
nmake /NOLOGO /f "ce.vcn" CFG="CE - Win32 (WCE SH3) Release Italian" CESubsystem=windowsce,2.0 CEVersion=211 CEConfigName="Pocket PC"
if NOT exist ..\%build_wce_static%\sh\it\release\dtstatic.lib echo Workspace %blddrv%%bldpath%\dapi\src\ce.vcn wce211 Palm Win32 (WCE SH3) Release Italian not build >> %blddrv%%bldpath%\build_log\errors\win_ce%index%.log
if NOT exist ..\%build_wce_static%\sh\it\release\dtstatic.lib set bug_sh_ce=1
...
if NOT exist ..\%build_wce_dll%\sh\gr\release\dectalk.dll set bug_sh_cedll=1
nmake /NOLOGO /f "cedll.vcn" CFG="cedll - Win32 (WCE SH3) Release Italian" CESubsystem=windowsce,2.0 CEVersion=211 CEConfigName="Pocket PC"
if NOT exist ..\%build_wce_dll%\sh\it\release\dectalk.dll echo Workspace %blddrv%%bldpath%\dapi\src\cedll.vcn wce211 Palm Win32 (WCE SH3) Release Italian not build >> %blddrv%%bldpath%\build_log\errors\win_ce%index%.log
if NOT exist ..\%build_wce_dll%\sh\it\release\dectalk.dll set bug_sh_cedll=1
...
if NOT exist ..\%build_wce_static%\x86em\gr\release\dtstatic.lib set bug_x86em_ce=1
nmake /NOLOGO /f "ce.vcn" CFG="CE - Win32 (WCE x86em) Release Italian" CESubsystem=windowsce,2.0 CEVersion=211 CEConfigName="Pocket PC"
if NOT exist ..\%build_wce_static%\x86em\it\release\dtstatic.lib echo Workspace %blddrv%%bldpath%\dapi\src\ce.vcn wce211 Palm Win32 (WCE X86EM) Release Italian not build >> %blddrv%%bldpath%\build_log\errors\win_ce%index%.log
if NOT exist ..\%build_wce_static%\x86em\it\release\dtstatic.lib set bug_x86em_ce=1
...
if NOT exist ..\%build_wce_dll%\x86em\gr\release\dectalk.dll set bug_x86em_cedll=1
nmake /NOLOGO /f "cedll.vcn" CFG="cedll - Win32 (WCE x86em) Release Italian" CESubsystem=windowsce,2.0 CEVersion=211 CEConfigName="Pocket PC"
if NOT exist ..\%build_wce_dll%\x86em\it\release\dectalk.dll echo Workspace %blddrv%%bldpath%\dapi\src\cedll.vcn wce211 Palm Win32 (WCE X86EM) Release Italian not build >> %blddrv%%bldpath%\build_log\errors\win_ce%index%.log
if NOT exist ..\%build_wce_dll%\x86em\it\release\dectalk.dll set bug_x86em_cedll=1
...
rem if "%bug_mips_ce%"=="1" goto wce211_palm_dtsample_mips_ce
...
nmake /NOLOGO /f "Dtsample.vcn" CFG="Dtsample - Win32 (WCE MIPS) Release Italian" CESubsystem=windowsce,2.0 CEVersion=211 CEConfigName="Pocket PC"
if NOT exist .\%build_static%\mips\it\release\dtsample.exe echo Workspace %blddrv%%bldpath%\samplece\dtsample\dtsample.vcn wce211 Palm Win32 (WCE MIPS) Release Italian not build >> %blddrv%%bldpath%\build_log\errors\win_ce%index%.log
:wce211_palm_dtsample_mips_ce

rem if "%bug_mips_cedll%"=="1" goto wce211_palm_dtsample_mips_cedll
...
nmake /NOLOGO /f "Dtsample.vcn" CFG="Dtsample - Win32 (WCE MIPS) Release Italian Dll" CESubsystem=windowsce,2.0 CEVersion=211 CEConfigName="Pocket PC"
if NOT exist .\%build_dll%\mips\it\release\dtsample.exe echo Workspace %blddrv%%bldpath%\samplece\dtsample\dtsample.vcn wce211 Palm Win32 (WCE MIPS) Release Italian Dll not build >> %blddrv%%bldpath%\build_log\errors\win_ce%index%.log
:wce211_palm_dtsample_mips_cedll

set LIB=%DEVROOT%\%PLATFORM%\ms palm size pc\lib\SH3;%DEVROOT%\%PLATFORM%\ms palm size pc\mfc\lib\SH3;

rem if "%bug_sh_ce%"=="1" goto wce211_palm_dtsample_sh_ce
...
nmake /NOLOGO /f "Dtsample.vcn" CFG="Dtsample - Win32 (WCE SH3) Release Italian" CESubsystem=windowsce,2.0 CEVersion=211 CEConfigName="Pocket PC"
if NOT exist .\%build_static%\sh\it\release\dtsample.exe echo Workspace %blddrv%%bldpath%\samplece\dtsample\dtsample.vcn wce211 Palm Win32 (WCE SH3) Release Italian not build >> %blddrv%%bldpath%\build_log\errors\win_ce%index%.log
:wce211_palm_dtsample_sh_ce

rem if "%bug_sh_cedll%"=="1" goto wce211_palm_dtsample_sh_cedll
...
nmake /NOLOGO /f "Dtsample.vcn" CFG="Dtsample - Win32 (WCE SH3) Release Italian Dll" CESubsystem=windowsce,2.0 CEVersion=211 CEConfigName="Pocket PC"
if NOT exist .\%build_dll%\sh\it\release\dtsample.exe echo Workspace %blddrv%%bldpath%\samplece\dtsample\dtsample.vcn wce211 Palm Win32 (WCE SH3) Release Italian Dll not build >> %blddrv%%bldpath%\build_log\errors\win_ce%index%.log
:wce211_palm_dtsample_sh_cedll

set LIB=%DEVROOT%\%PLATFORM%\ms palm size pc\lib\X86em;%DEVROOT%\%PLATFORM%\ms palm size pc\mfc\lib\X86em;

rem if "%bug_x86em_ce%"=="1" goto wce211_palm_dtsample_x86em_ce
...
nmake /NOLOGO /f "Dtsample.vcn" CFG="Dtsample - Win32 (WCE x86em) Release Italian" CESubsystem=windowsce,2.0 CEVersion=211 CEConfigName="Pocket PC"
if NOT exist .\%build_static%\x86em\it\release\dtsample.exe echo Workspace %blddrv%%bldpath%\samplece\dtsample\dtsample.vcn wce211 Palm Win32 (WCE X86EM) Release Italian not build >> %blddrv%%bldpath%\build_log\errors\win_ce%index%.log
:wce211_palm_dtsample_x86em_ce

rem if "%bug_x86em_cedll%"=="1" goto wce211_palm_dtsample_x86em_cedll
...
nmake /NOLOGO /f "Dtsample.vcn" CFG="Dtsample - Win32 (WCE x86em) Release Italian Dll" CESubsystem=windowsce,2.0 CEVersion=211 CEConfigName="Pocket PC"
if NOT exist .\%build_static%\x86em\it\release\dtsample.exe echo Workspace %blddrv%%bldpath%\samplece\dtsample\dtsample.vcn wce211 Palm Win32 (WCE X86EM) Release Italian Dll not build >> %blddrv%%bldpath%\build_log\errors\win_ce%index%.log
...
rem if "%bug_mips_ce%"=="1" goto wce211_palm_cetalk_mips_ce
...
nmake /NOLOGO /f "CEtalk.vcn" CFG="CEtalk - Win32 (WCE MIPS) Release Italian" CESubsystem=windowsce,2.0 CEVersion=211 CEConfigName="Pocket PC"
if NOT exist .\%build_static%\mips\it\release\dtalk_it.exe echo Workspace %blddrv%%bldpath%\samplece\cetalk\cetalk.vcn wce211 Palm Win32 (WCE MIPS) Release Italian not build >> %blddrv%%bldpath%\build_log\errors\win_ce%index%.log
:wce211_palm_cetalk_mips_ce

rem if "%bug_mips_cedll%"=="1" goto wce211_palm_cetalk_mips_cedll
...
nmake /NOLOGO /f "CEtalk.vcn" CFG="CEtalk - Win32 (WCE MIPS) Release Italian dll" CESubsystem=windowsce,2.0 CEVersion=211 CEConfigName="Pocket PC"
if NOT exist .\%build_dll%\mips\it\release\dtalk_it.exe echo Workspace %blddrv%%bldpath%\samplece\cetalk\cetalk.vcn wce211 Palm Win32 (WCE MIPS) Release Italian Dll not build >> %blddrv%%bldpath%\build_log\errors\win_ce%index%.log
:wce211_palm_cetalk_mips_cedll

set LIB=%DEVROOT%\%PLATFORM%\ms palm size pc\lib\SH3;%DEVROOT%\%PLATFORM%\ms palm size pc\mfc\lib\SH3;

rem if "%bug_sh_ce%"=="1" goto wce211_palm_cetalk_sh_ce
...
nmake /NOLOGO /f "CEtalk.vcn" CFG="CEtalk - Win32 (WCE SH3) Release Italian" CESubsystem=windowsce,2.0 CEVersion=211 CEConfigName="Pocket PC"
if NOT exist .\%build_static%\sh\it\release\dtalk_it.exe echo Workspace %blddrv%%bldpath%\samplece\cetalk\cetalk.vcn wce211 Palm Win32 (WCE SH3) Release Italian not build >> %blddrv%%bldpath%\build_log\errors\win_ce%index%.log
:wce211_palm_cetalk_sh_ce

rem if "%bug_sh_cedll%"=="1" goto wce211_palm_cetalk_sh_cedll
...
nmake /NOLOGO /f "CEtalk.vcn" CFG="CEtalk - Win32 (WCE SH3) Release Italian dll" CESubsystem=windowsce,2.0 CEVersion=211 CEConfigName="Pocket PC"
if NOT exist .\%build_dll%\sh\it\release\dtalk_it.exe echo Workspace %blddrv%%bldpath%\samplece\cetalk\cetalk.vcn wce211 Palm Win32 (WCE SH3) Release Italian Dll not build >> %blddrv%%bldpath%\build_log\errors\win_ce%index%.log
:wce211_palm_cetalk_sh_cedll

set LIB=%DEVROOT%\%PLATFORM%\ms palm size pc\lib\X86em;%DEVROOT%\%PLATFORM%\ms palm size pc\mfc\lib\X86em;

rem if "%bug_x86em_ce%"=="1" goto wce211_palm_cetalk_x86em_ce
...
nmake /NOLOGO /f "CEtalk.vcn" CFG="CEtalk - Win32 (WCE x86em) Release Italian" CESubsystem=windowsce,2.0 CEVersion=211 CEConfigName="Pocket PC"
if NOT exist .\%build_static%\x86em\it\release\dtalk_it.exe echo Workspace %blddrv%%bldpath%\samplece\cetalk\cetalk.vcn wce211 Palm Win32 (WCE X86EM) Release Italian not build >> %blddrv%%bldpath%\build_log\errors\win_ce%index%.log
:wce211_palm_cetalk_x86em_ce

rem if "%bug_x86em_cedll%"=="1" goto wce211_palm_cetalk_x86em_cedll
...
nmake /NOLOGO /f "CEtalk.vcn" CFG="CEtalk - Win32 (WCE x86em) Release Italian dll" CESubsystem=windowsce,2.0 CEVersion=211 CEConfigName="Pocket PC"
if NOT exist .\%build_dll%\x86em\it\release\dtalk_it.exe echo Workspace %blddrv%%bldpath%\samplece\cetalk\cetalk.vcn wce211 Palm Win32 (WCE X86EM) Release Italian Dll not build >> %blddrv%%bldpath%\build_log\errors\win_ce%index%.log
...
set bug_arm_ce=0
set bug_arm_cedll=0
set bug_arm_cedllvb=0
set bug_mips_ce=0
set bug_mips_cedll=0
set bug_mips_cedllvb=0
set bug_sh_ce=0
set bug_sh_cedll=0
set bug_sh_cedllvb=0
set bug_sh4_ce=0
set bug_sh4_cedll=0
set bug_sh4_cedllvb=0
set bug_x86em_ce=0
set bug_x86em_cedll=0
...
if exist .\dapi\build\%PLATFORM%\pocket\cedllvb 					move .\dapi\build\%PLATFORM%\pocket\cedllvb				.\dapi\build\cedllvb
...
if NOT exist ..\%build_wce_static%\arm\gr\release\dtstatic.lib set bug_arm_ce=1
nmake /NOLOGO /f "ce.vcn" CFG="CE - Win32 (WCE ARM) Release Italian" CESubsystem=windowsce,3.00 CEVersion=300 CEConfigName="Pocket PC"
if NOT exist ..\%build_wce_static%\arm\it\release\dtstatic.lib echo Workspace %blddrv%%bldpath%\dapi\src\ce.vcn wce300 Pocket PC Win32 (WCE ARM) Release Italian not build >> %blddrv%%bldpath%\build_log\errors\win_ce%index%.log
if NOT exist ..\%build_wce_static%\arm\it\release\dtstatic.lib set bug_arm_ce=1
...
copy /Y ..\%build_wce_static%\arm\it\release\*.* ..\%build_wce_static%\xscale\it\release\
...
if NOT exist ..\%build_wce_dll%\arm\gr\release\dectalk.dll set bug_arm_cedll=1
nmake /NOLOGO /f "cedll.vcn" CFG="cedll - Win32 (WCE ARM) Release Italian" CESubsystem=windowsce,3.00 CEVersion=300 CEConfigName="Pocket PC"
if NOT exist ..\%build_wce_dll%\arm\it\release\dectalk.dll echo Workspace %blddrv%%bldpath%\dapi\src\cedll.vcn wce300 Pocket PC Win32 (WCE ARM) Release Italian not build >> %blddrv%%bldpath%\build_log\errors\win_ce%index%.log
if NOT exist ..\%build_wce_dll%\arm\it\release\dectalk.dll set bug_arm_cedll=1


nmake /NOLOGO /f "cedllvb.vcn" CFG="cedllvb - Win32 (WCE ARM) Release" CESubsystem=windowsce,3.00 CEVersion=300 CEConfigName="Pocket PC"
if NOT exist ..\%build_wce_dllvb%\arm\us\release\dectalkvb.dll echo Workspace %blddrv%%bldpath%\dapi\src\cedllvb.vcn wce300 Pocket PC Win32 (WCE ARM) Release not build >> %blddrv%%bldpath%\build_log\errors\win_ce%index%.log
if NOT exist ..\%build_wce_dllvb%\arm\us\release\dectalkvb.dll set bug_arm_cedll=1
nmake /NOLOGO /f "cedllvb.vcn" CFG="cedllvb - Win32 (WCE ARM) Release Spanish" CESubsystem=windowsce,3.00 CEVersion=300 CEConfigName="Pocket PC"
if NOT exist ..\%build_wce_dllvb%\arm\us\release\dectalkvb.dll echo Workspace %blddrv%%bldpath%\dapi\src\cedllvb.vcn wce300 Pocket PC Win32 (WCE ARM) Release Spanish not build >> %blddrv%%bldpath%\build_log\errors\win_ce%index%.log
if NOT exist ..\%build_wce_dllvb%\arm\us\release\dectalkvb.dll set bug_arm_cedll=1
nmake /NOLOGO /f "cedllvb.vcn" CFG="cedllvb - Win32 (WCE ARM) Release Latin American" CESubsystem=windowsce,3.00 CEVersion=300 CEConfigName="Pocket PC"
if NOT exist ..\%build_wce_dllvb%\arm\us\release\dectalkvb.dll echo Workspace %blddrv%%bldpath%\dapi\src\cedllvb.vcn wce300 Pocket PC Win32 (WCE ARM) Release Latin American not build >> %blddrv%%bldpath%\build_log\errors\win_ce%index%.log
if NOT exist ..\%build_wce_dllvb%\arm\us\release\dectalkvb.dll set bug_arm_cedll=1
nmake /NOLOGO /f "cedllvb.vcn" CFG="cedllvb - Win32 (WCE ARM) Release English UK" CESubsystem=windowsce,3.00 CEVersion=300 CEConfigName="Pocket PC"
if NOT exist ..\%build_wce_dllvb%\arm\us\release\dectalkvb.dll echo Workspace %blddrv%%bldpath%\dapi\src\cedllvb.vcn wce300 Pocket PC Win32 (WCE ARM) Release English UK not build >> %blddrv%%bldpath%\build_log\errors\win_ce%index%.log
if NOT exist ..\%build_wce_dllvb%\arm\us\release\dectalkvb.dll set bug_arm_cedll=1
nmake /NOLOGO /f "cedllvb.vcn" CFG="cedllvb - Win32 (WCE ARM) Release French" CESubsystem=windowsce,3.00 CEVersion=300 CEConfigName="Pocket PC"
if NOT exist ..\%build_wce_dllvb%\arm\us\release\dectalkvb.dll echo Workspace %blddrv%%bldpath%\dapi\src\cedllvb.vcn wce300 Pocket PC Win32 (WCE ARM) Release French not build >> %blddrv%%bldpath%\build_log\errors\win_ce%index%.log
if NOT exist ..\%build_wce_dllvb%\arm\us\release\dectalkvb.dll set bug_arm_cedll=1
nmake /NOLOGO /f "cedllvb.vcn" CFG="cedllvb - Win32 (WCE ARM) Release German" CESubsystem=windowsce,3.00 CEVersion=300 CEConfigName="Pocket PC"
if NOT exist ..\%build_wce_dllvb%\arm\us\release\dectalkvb.dll echo Workspace %blddrv%%bldpath%\dapi\src\cedllvb.vcn wce300 Pocket PC Win32 (WCE ARM) Release German not build >> %blddrv%%bldpath%\build_log\errors\win_ce%index%.log
if NOT exist ..\%build_wce_dllvb%\arm\us\release\dectalkvb.dll set bug_arm_cedll=1
nmake /NOLOGO /f "cedllvb.vcn" CFG="cedllvb - Win32 (WCE ARM) Release Italian" CESubsystem=windowsce,3.00 CEVersion=300 CEConfigName="Pocket PC"
if NOT exist ..\%build_wce_dllvb%\arm\us\release\dectalkvb.dll echo Workspace %blddrv%%bldpath%\dapi\src\cedllvb.vcn wce300 Pocket PC Win32 (WCE ARM) Release Italian not build >> %blddrv%%bldpath%\build_log\errors\win_ce%index%.log
if NOT exist ..\%build_wce_dllvb%\arm\us\release\dectalkvb.dll set bug_arm_cedll=1
...
copy /Y ..\%build_wce_dll%\arm\it\release\*.* ..\%build_wce_dll%\xscale\it\release\

mkdir ..\%build_wce_dllvb%\xscale
xcopy /T ..\%build_wce_dllvb%\arm ..\%build_wce_dllvb%\xscale

copy /Y ..\%build_wce_dllvb%\arm\us\release\*.* ..\%build_wce_dllvb%\xscale\us\release\ 
copy /Y ..\%build_wce_dllvb%\arm\uk\release\*.* ..\%build_wce_dllvb%\xscale\uk\release\ 
copy /Y ..\%build_wce_dllvb%\arm\fr\release\*.* ..\%build_wce_dllvb%\xscale\fr\release\ 
copy /Y ..\%build_wce_dllvb%\arm\sp\release\*.* ..\%build_wce_dllvb%\xscale\sp\release\ 
copy /Y ..\%build_wce_dllvb%\arm\la\release\*.* ..\%build_wce_dllvb%\xscale\la\release\ 
copy /Y ..\%build_wce_dllvb%\arm\gr\release\*.* ..\%build_wce_dllvb%\xscale\gr\release\
copy /Y ..\%build_wce_dllvb%\arm\it\release\*.* ..\%build_wce_dllvb%\xscale\it\release\
...
if NOT exist ..\%build_wce_static%\mips\gr\release\dtstatic.lib set bug_mips_ce=1
nmake /NOLOGO /f "ce.vcn" CFG="CE - Win32 (WCE MIPS) Release Italian" CESubsystem=windowsce,3.00 CEVersion=300 CEConfigName="Pocket PC"
if NOT exist ..\%build_wce_static%\mips\it\release\dtstatic.lib echo Workspace %blddrv%%bldpath%\dapi\src\ce.vcn wce300 Pocket PC Win32 (WCE MIPS) Release Italian not build >> %blddrv%%bldpath%\build_log\errors\win_ce%index%.log
if NOT exist ..\%build_wce_static%\mips\it\release\dtstatic.lib set bug_mips_ce=1
...
if NOT exist ..\%build_wce_dll%\mips\gr\release\dectalk.dll set bug_mips_cedll=1
nmake /NOLOGO /f "cedll.vcn" CFG="cedll - Win32 (WCE MIPS) Release Italian" CESubsystem=windowsce,3.00 CEVersion=300 CEConfigName="Pocket PC"
if NOT exist ..\%build_wce_dll%\mips\it\release\dectalk.dll echo Workspace %blddrv%%bldpath%\dapi\src\cedll.vcn wce300 Pocket PC Win32 (WCE MIPS) Release Italian not build >> %blddrv%%bldpath%\build_log\errors\win_ce%index%.log
if NOT exist ..\%build_wce_dll%\mips\it\release\dectalk.dll set bug_mips_cedll=1

nmake /NOLOGO /f "cedllvb.vcn" CFG="cedllvb - Win32 (WCE MIPS) Release" CESubsystem=windowsce,3.00 CEVersion=300 CEConfigName="Pocket PC"
if NOT exist ..\%build_wce_dllvb%\mips\us\release\dectalkvb.dll echo Workspace %blddrv%%bldpath%\dapi\src\cedllvb.vcn wce300 Pocket PC Win32 (WCE MIPS) Release not build >> %blddrv%%bldpath%\build_log\errors\win_ce%index%.log
if NOT exist ..\%build_wce_dllvb%\mips\us\release\dectalkvb.dll set bug_mips_cedllvb=1
nmake /NOLOGO /f "cedllvb.vcn" CFG="cedllvb - Win32 (WCE MIPS) Release Spanish" CESubsystem=windowsce,3.00 CEVersion=300 CEConfigName="Pocket PC"
if NOT exist ..\%build_wce_dllvb%\mips\us\release\dectalkvb.dll echo Workspace %blddrv%%bldpath%\dapi\src\cedllvb.vcn wce300 Pocket PC Win32 (WCE MIPS) Release Spanish not build >> %blddrv%%bldpath%\build_log\errors\win_ce%index%.log
if NOT exist ..\%build_wce_dllvb%\mips\us\release\dectalkvb.dll set bug_mips_cedllvb=1
nmake /NOLOGO /f "cedllvb.vcn" CFG="cedllvb - Win32 (WCE MIPS) Release Latin American" CESubsystem=windowsce,3.00 CEVersion=300 CEConfigName="Pocket PC"
if NOT exist ..\%build_wce_dllvb%\mips\us\release\dectalkvb.dll echo Workspace %blddrv%%bldpath%\dapi\src\cedllvb.vcn wce300 Pocket PC Win32 (WCE MIPS) Release Latin American not build >> %blddrv%%bldpath%\build_log\errors\win_ce%index%.log
if NOT exist ..\%build_wce_dllvb%\mips\us\release\dectalkvb.dll set bug_mips_cedllvb=1
nmake /NOLOGO /f "cedllvb.vcn" CFG="cedllvb - Win32 (WCE MIPS) Release English UK" CESubsystem=windowsce,3.00 CEVersion=300 CEConfigName="Pocket PC"
if NOT exist ..\%build_wce_dllvb%\mips\us\release\dectalkvb.dll echo Workspace %blddrv%%bldpath%\dapi\src\cedllvb.vcn wce300 Pocket PC Win32 (WCE MIPS) Release English UK not build >> %blddrv%%bldpath%\build_log\errors\win_ce%index%.log
if NOT exist ..\%build_wce_dllvb%\mips\us\release\dectalkvb.dll set bug_mips_cedllvb=1
nmake /NOLOGO /f "cedllvb.vcn" CFG="cedllvb - Win32 (WCE MIPS) Release French" CESubsystem=windowsce,3.00 CEVersion=300 CEConfigName="Pocket PC"
if NOT exist ..\%build_wce_dllvb%\mips\us\release\dectalkvb.dll echo Workspace %blddrv%%bldpath%\dapi\src\cedllvb.vcn wce300 Pocket PC Win32 (WCE MIPS) Release French not build >> %blddrv%%bldpath%\build_log\errors\win_ce%index%.log
if NOT exist ..\%build_wce_dllvb%\mips\us\release\dectalkvb.dll set bug_mips_cedllvb=1
nmake /NOLOGO /f "cedllvb.vcn" CFG="cedllvb - Win32 (WCE MIPS) Release German" CESubsystem=windowsce,3.00 CEVersion=300 CEConfigName="Pocket PC"
if NOT exist ..\%build_wce_dllvb%\mips\us\release\dectalkvb.dll echo Workspace %blddrv%%bldpath%\dapi\src\cedllvb.vcn wce300 Pocket PC Win32 (WCE MIPS) Release German not build >> %blddrv%%bldpath%\build_log\errors\win_ce%index%.log
if NOT exist ..\%build_wce_dllvb%\mips\us\release\dectalkvb.dll set bug_mips_cedllvb=1
nmake /NOLOGO /f "cedllvb.vcn" CFG="cedllvb - Win32 (WCE MIPS) Release Italian" CESubsystem=windowsce,3.00 CEVersion=300 CEConfigName="Pocket PC"
if NOT exist ..\%build_wce_dllvb%\mips\us\release\dectalkvb.dll echo Workspace %blddrv%%bldpath%\dapi\src\cedllvb.vcn wce300 Pocket PC Win32 (WCE MIPS) Release Italian not build >> %blddrv%%bldpath%\build_log\errors\win_ce%index%.log
if NOT exist ..\%build_wce_dllvb%\mips\us\release\dectalkvb.dll set bug_mips_cedllvb=1
...
if NOT exist ..\%build_wce_static%\sh\gr\release\dtstatic.lib set bug_sh_ce=1
nmake /NOLOGO /f "ce.vcn" CFG="CE - Win32 (WCE SH3) Release Italian" CESubsystem=windowsce,3.00 CEVersion=300 CEConfigName="Pocket PC"
if NOT exist ..\%build_wce_static%\sh\it\release\dtstatic.lib echo Workspace %blddrv%%bldpath%\dapi\src\ce.vcn wce300 Pocket PC Win32 (WCE SH3) Release Italian not build >> %blddrv%%bldpath%\build_log\errors\win_ce%index%.log
if NOT exist ..\%build_wce_static%\sh\it\release\dtstatic.lib set bug_sh_ce=1
...
if NOT exist ..\%build_wce_dll%\sh\gr\release\dectalk.dll set bug_sh_cedll=1
nmake /NOLOGO /f "cedll.vcn" CFG="cedll - Win32 (WCE SH3) Release Italian" CESubsystem=windowsce,3.00 CEVersion=300 CEConfigName="Pocket PC"
if NOT exist ..\%build_wce_dll%\sh\it\release\dectalk.dll echo Workspace %blddrv%%bldpath%\dapi\src\cedll.vcn wce300 Pocket PC Win32 (WCE SH3) Release Italian not build >> %blddrv%%bldpath%\build_log\errors\win_ce%index%.log
if NOT exist ..\%build_wce_dll%\sh\it\release\dectalk.dll set bug_sh_cedll=1


nmake /NOLOGO /f "cedllvb.vcn" CFG="cedllvb - Win32 (WCE SH3) Release" CESubsystem=windowsce,3.00 CEVersion=300 CEConfigName="Pocket PC"
if NOT exist ..\%build_wce_dllvb%\sh\us\release\dectalkvb.dll echo Workspace %blddrv%%bldpath%\dapi\src\cedllvb.vcn wce300 Pocket PC Win32 (WCE SH3) Release not build >> %blddrv%%bldpath%\build_log\errors\win_ce%index%.log
if NOT exist ..\%build_wce_dllvb%\sh\us\release\dectalkvb.dll set bug_sh_cedllvb=1
nmake /NOLOGO /f "cedllvb.vcn" CFG="cedllvb - Win32 (WCE SH3) Release Spanish" CESubsystem=windowsce,3.00 CEVersion=300 CEConfigName="Pocket PC"
if NOT exist ..\%build_wce_dllvb%\sh\us\release\dectalkvb.dll echo Workspace %blddrv%%bldpath%\dapi\src\cedllvb.vcn wce300 Pocket PC Win32 (WCE SH3) Release Spanish not build >> %blddrv%%bldpath%\build_log\errors\win_ce%index%.log
if NOT exist ..\%build_wce_dllvb%\sh\us\release\dectalkvb.dll set bug_sh_cedllvb=1
nmake /NOLOGO /f "cedllvb.vcn" CFG="cedllvb - Win32 (WCE SH3) Release Latin American" CESubsystem=windowsce,3.00 CEVersion=300 CEConfigName="Pocket PC"
if NOT exist ..\%build_wce_dllvb%\sh\us\release\dectalkvb.dll echo Workspace %blddrv%%bldpath%\dapi\src\cedllvb.vcn wce300 Pocket PC Win32 (WCE SH3) Release Latin American not build >> %blddrv%%bldpath%\build_log\errors\win_ce%index%.log
if NOT exist ..\%build_wce_dllvb%\sh\us\release\dectalkvb.dll set bug_sh_cedllvb=1
nmake /NOLOGO /f "cedllvb.vcn" CFG="cedllvb - Win32 (WCE SH3) Release English UK" CESubsystem=windowsce,3.00 CEVersion=300 CEConfigName="Pocket PC"
if NOT exist ..\%build_wce_dllvb%\sh\us\release\dectalkvb.dll echo Workspace %blddrv%%bldpath%\dapi\src\cedllvb.vcn wce300 Pocket PC Win32 (WCE SH3) Release English UK not build >> %blddrv%%bldpath%\build_log\errors\win_ce%index%.log
if NOT exist ..\%build_wce_dllvb%\sh\us\release\dectalkvb.dll set bug_sh_cedllvb=1
nmake /NOLOGO /f "cedllvb.vcn" CFG="cedllvb - Win32 (WCE SH3) Release French" CESubsystem=windowsce,3.00 CEVersion=300 CEConfigName="Pocket PC"
if NOT exist ..\%build_wce_dllvb%\sh\us\release\dectalkvb.dll echo Workspace %blddrv%%bldpath%\dapi\src\cedllvb.vcn wce300 Pocket PC Win32 (WCE SH3) Release French not build >> %blddrv%%bldpath%\build_log\errors\win_ce%index%.log
if NOT exist ..\%build_wce_dllvb%\sh\us\release\dectalkvb.dll set bug_sh_cedllvb=1
nmake /NOLOGO /f "cedllvb.vcn" CFG="cedllvb - Win32 (WCE SH3) Release German" CESubsystem=windowsce,3.00 CEVersion=300 CEConfigName="Pocket PC"
if NOT exist ..\%build_wce_dllvb%\sh\us\release\dectalkvb.dll echo Workspace %blddrv%%bldpath%\dapi\src\cedllvb.vcn wce300 Pocket PC Win32 (WCE SH3) Release German not build >> %blddrv%%bldpath%\build_log\errors\win_ce%index%.log
if NOT exist ..\%build_wce_dllvb%\sh\us\release\dectalkvb.dll set bug_sh_cedllvb=1
nmake /NOLOGO /f "cedllvb.vcn" CFG="cedllvb - Win32 (WCE SH3) Release Italian" CESubsystem=windowsce,3.00 CEVersion=300 CEConfigName="Pocket PC"
if NOT exist ..\%build_wce_dllvb%\sh\us\release\dectalkvb.dll echo Workspace %blddrv%%bldpath%\dapi\src\cedllvb.vcn wce300 Pocket PC Win32 (WCE SH3) Release Italian not build >> %blddrv%%bldpath%\build_log\errors\win_ce%index%.log
if NOT exist ..\%build_wce_dllvb%\sh\us\release\dectalkvb.dll set bug_sh_cedllvb=1
...
if NOT exist ..\%build_wce_static%\x86em\gr\release\dtstatic.lib set bug_x86em_ce=1
nmake /NOLOGO /f "ce.vcn" CFG="CE - Win32 (WCE x86em) Release Italian" CESubsystem=windowsce,3.00 CEVersion=300 CEConfigName="Pocket PC"
if NOT exist ..\%build_wce_static%\x86em\it\release\dtstatic.lib echo Workspace %blddrv%%bldpath%\dapi\src\ce.vcn wce300 Pocket PC Win32 (WCE X86EM) Release Italian not build >> %blddrv%%bldpath%\build_log\errors\win_ce%index%.log
if NOT exist ..\%build_wce_static%\x86em\it\release\dtstatic.lib set bug_x86em_ce=1
...
if NOT exist ..\%build_wce_dll%\x86em\gr\release\dectalk.dll set bug_x86em_cedll=1
nmake /NOLOGO /f "cedll.vcn" CFG="cedll - Win32 (WCE x86em) Release Italian" CESubsystem=windowsce,3.00 CEVersion=300 CEConfigName="Pocket PC"
if NOT exist ..\%build_wce_dll%\x86em\it\release\dectalk.dll echo Workspace %blddrv%%bldpath%\dapi\src\cedll.vcn wce300 Pocket PC Win32 (WCE X86EM) Release Italian not build >> %blddrv%%bldpath%\build_log\errors\win_ce%index%.log
if NOT exist ..\%build_wce_dll%\x86em\it\release\dectalk.dll set bug_x86em_cedll=1
...
rem if "%bug_arm_ce%"=="1" goto wce300_pocket_dtsample_arm_ce
...
nmake /NOLOGO /f "Dtsample.vcn" CFG="Dtsample - Win32 (WCE ARM) Release Italian" CESubsystem=windowsce,3.00 CEVersion=300 CEConfigName="Pocket PC"
if NOT exist .\%build_static%\arm\it\release\dtsample.exe echo Workspace %blddrv%%bldpath%\samplece\dtsample\dtsample.vcn wce300 Pocket PC Win32 (WCE ARM) Release Italian not build >> %blddrv%%bldpath%\build_log\errors\win_ce%index%.log
:wce300_pocket_dtsample_arm_ce

rem if "%bug_arm_cedll%"=="1" goto wce300_pocket_dtsample_arm_cedll
...
nmake /NOLOGO /f "Dtsample.vcn" CFG="Dtsample - Win32 (WCE ARM) Release Italian dll" CESubsystem=windowsce,3.00 CEVersion=300 CEConfigName="Pocket PC"
if NOT exist .\%build_dll%\arm\it\release\dtsample.exe echo Workspace %blddrv%%bldpath%\samplece\dtsample\dtsample.vcn wce300 Pocket PC Win32 (WCE ARM) Release Italian Dll not build >> %blddrv%%bldpath%\build_log\errors\win_ce%index%.log
...
rem if "%bug_mips_ce%"=="1" goto wce300_pocket_dtsample_mips_ce
...
nmake /NOLOGO /f "Dtsample.vcn" CFG="Dtsample - Win32 (WCE MIPS) Release Italian" CESubsystem=windowsce,3.00 CEVersion=300 CEConfigName="Pocket PC"
if NOT exist .\%build_static%\mips\it\release\dtsample.exe echo Workspace %blddrv%%bldpath%\samplece\dtsample\dtsample.vcn wce300 Pocket PC Win32 (WCE MIPS) Release Italian not build >> %blddrv%%bldpath%\build_log\errors\win_ce%index%.log
:wce300_pocket_dtsample_mips_ce

rem if "%bug_mips_cedll%"=="1" goto wce300_pocket_dtsample_mips_cedll
...
nmake /NOLOGO /f "Dtsample.vcn" CFG="Dtsample - Win32 (WCE MIPS) Release Italian Dll" CESubsystem=windowsce,3.00 CEVersion=300 CEConfigName="Pocket PC"
if NOT exist .\%build_dll%\mips\it\release\dtsample.exe echo Workspace %blddrv%%bldpath%\samplece\dtsample\dtsample.vcn wce300 Pocket PC Win32 (WCE MIPS) Release Italian Dll not build >> %blddrv%%bldpath%\build_log\errors\win_ce%index%.log
:wce300_pocket_dtsample_mips_cedll

set LIB=%DEVROOT%\%PLATFORM%\MS Pocket PC\lib\SH3;%DEVROOT%\%PLATFORM%\MS Pocket PC\mfc\lib\SH3;

rem if "%bug_sh3_ce%"=="1" goto wce300_pocket_dtsample_sh3_ce
...
nmake /NOLOGO /f "Dtsample.vcn" CFG="Dtsample - Win32 (WCE SH3) Release Italian" CESubsystem=windowsce,3.00 CEVersion=300 CEConfigName="Pocket PC"
if NOT exist .\%build_static%\sh\it\release\dtsample.exe echo Workspace %blddrv%%bldpath%\samplece\dtsample\dtsample.vcn wce300 Pocket PC Win32 (WCE SH3) Release Italian not build >> %blddrv%%bldpath%\build_log\errors\win_ce%index%.log
:wce300_pocket_dtsample_sh3_ce

rem if "%bug_sh3_cedll%"=="1" goto wce300_pocket_dtsample_sh3_cedll
...
nmake /NOLOGO /f "Dtsample.vcn" CFG="Dtsample - Win32 (WCE SH3) Release Italian Dll" CESubsystem=windowsce,3.00 CEVersion=300 CEConfigName="Pocket PC"
if NOT exist .\%build_dll%\sh\it\release\dtsample.exe echo Workspace %blddrv%%bldpath%\samplece\dtsample\dtsample.vcn wce300 Pocket PC Win32 (WCE SH3) Release Italian Dll not build >> %blddrv%%bldpath%\build_log\errors\win_ce%index%.log
:wce300_pocket_dtsample_sh3_cedll

set LIB=%DEVROOT%\%PLATFORM%\MS Pocket PC\lib\X86em;%DEVROOT%\%PLATFORM%\MS Pocket PC\mfc\lib\X86em;

rem if "%bug_x86em_ce%"=="1" goto wce300_pocket_dtsample_x86em_ce
...
nmake /NOLOGO /f "Dtsample.vcn" CFG="Dtsample - Win32 (WCE x86em) Release Italian" CESubsystem=windowsce,3.00 CEVersion=300 CEConfigName="Pocket PC"
if NOT exist .\%build_static%\x86em\it\release\dtsample.exe echo Workspace %blddrv%%bldpath%\samplece\dtsample\dtsample.vcn wce300 Pocket PC Win32 (WCE X86EM) Release Italian not build >> %blddrv%%bldpath%\build_log\errors\win_ce%index%.log
:wce300_pocket_dtsample_x86em_ce

rem if "%bug_x86em_cedll%"=="1" goto wce300_pocket_dtsample_x86em_cedll
...
nmake /NOLOGO /f "Dtsample.vcn" CFG="Dtsample - Win32 (WCE x86em) Release Italian Dll" CESubsystem=windowsce,3.00 CEVersion=300 CEConfigName="Pocket PC"
if NOT exist .\%build_dll%\x86em\it\release\dtsample.exe echo Workspace %blddrv%%bldpath%\samplece\dtsample\dtsample.vcn wce300 Pocket PC Win32 (WCE X86EM) Release Italian Dll not build >> %blddrv%%bldpath%\build_log\errors\win_ce%index%.log
...
rem if "%bug_arm_ce%"=="1" goto wce300_pocket_cetalk_arm_ce
...
nmake /NOLOGO /f "CEtalk.vcn" CFG="CEtalk - Win32 (WCE ARM) Release Italian" CESubsystem=windowsce,3.00 CEVersion=300 CEConfigName="Pocket PC"
if NOT exist .\%build_static%\arm\it\release\dtalk_it.exe echo Workspace %blddrv%%bldpath%\samplece\cetalk\cetalk.vcn wce300 Pocket PC Win32 (WCE ARM) Release Italian not build >> %blddrv%%bldpath%\build_log\errors\win_ce%index%.log
:wce300_pocket_cetalk_arm_ce

rem if "%bug_arm_cedll%"=="1" goto wce300_pocket_cetalk_arm_cedll
...
nmake /NOLOGO /f "CEtalk.vcn" CFG="CEtalk - Win32 (WCE ARM) Release Italian dll" CESubsystem=windowsce,3.00 CEVersion=300 CEConfigName="Pocket PC"
if NOT exist .\%build_dll%\arm\it\release\dtalk_it.exe echo Workspace %blddrv%%bldpath%\samplece\cetalk\cetalk.vcn wce300 Pocket PC Win32 (WCE ARM) Release Italian Dll not build >> %blddrv%%bldpath%\build_log\errors\win_ce%index%.log
:wce300_pocket_cetalk_arm_cedll

set LIB=%DEVROOT%\%PLATFORM%\MS Pocket PC\lib\MIPS;%DEVROOT%\%PLATFORM%\MS Pocket PC\mfc\lib\MIPS;

rem if "%bug_mips_ce%"=="1" goto wce300_pocket_cetalk_mips_ce
...
nmake /NOLOGO /f "CEtalk.vcn" CFG="CEtalk - Win32 (WCE MIPS) Release Italian" CESubsystem=windowsce,3.00 CEVersion=300 CEConfigName="Pocket PC"
if NOT exist .\%build_static%\mips\it\release\dtalk_it.exe echo Workspace %blddrv%%bldpath%\samplece\cetalk\cetalk.vcn wce300 Pocket PC Win32 (WCE MIPS) Release Italian not build >> %blddrv%%bldpath%\build_log\errors\win_ce%index%.log
:wce300_pocket_cetalk_mips_ce

rem if "%bug_mips_cedll%"=="1" goto wce300_pocket_cetalk_mips_cedll
...
nmake /NOLOGO /f "CEtalk.vcn" CFG="CEtalk - Win32 (WCE MIPS) Release Italian dll" CESubsystem=windowsce,3.00 CEVersion=300 CEConfigName="Pocket PC"
if NOT exist .\%build_dll%\mips\it\release\dtalk_it.exe echo Workspace %blddrv%%bldpath%\samplece\cetalk\cetalk.vcn wce300 Pocket PC Win32 (WCE MIPS) Release Italian Dll not build >> %blddrv%%bldpath%\build_log\errors\win_ce%index%.log
:wce300_pocket_cetalk_mips_cedll

set LIB=%DEVROOT%\%PLATFORM%\MS Pocket PC\lib\SH3;%DEVROOT%\%PLATFORM%\MS Pocket PC\mfc\lib\SH3;

rem if "%bug_sh_ce%"=="1" goto wce300_pocket_cetalk_sh_ce
...
nmake /NOLOGO /f "CEtalk.vcn" CFG="CEtalk - Win32 (WCE SH3) Release Italian" CESubsystem=windowsce,3.00 CEVersion=300 CEConfigName="Pocket PC"
if NOT exist .\%build_static%\sh\it\release\dtalk_it.exe echo Workspace %blddrv%%bldpath%\samplece\cetalk\cetalk.vcn wce300 Pocket PC Win32 (WCE SH3) Release Italian not build >> %blddrv%%bldpath%\build_log\errors\win_ce%index%.log
:wce300_pocket_cetalk_sh_ce

rem if "%bug_sh_cedll%"=="1" goto wce300_pocket_cetalk_sh_cedll
...
nmake /NOLOGO /f "CEtalk.vcn" CFG="CEtalk - Win32 (WCE SH3) Release Italian dll" CESubsystem=windowsce,3.00 CEVersion=300 CEConfigName="Pocket PC"
if NOT exist .\%build_dll%\sh\it\release\dtalk_it.exe echo Workspace %blddrv%%bldpath%\samplece\cetalk\cetalk.vcn wce300 Pocket PC Win32 (WCE SH3) Release Italian Dll not build >> %blddrv%%bldpath%\build_log\errors\win_ce%index%.log
:wce300_pocket_cetalk_sh_cedll

set LIB=%DEVROOT%\%PLATFORM%\MS Pocket PC\lib\X86em;%DEVROOT%\%PLATFORM%\MS Pocket PC\mfc\lib\X86em;

rem if "%bug_x86em_ce%"=="1" goto wce300_pocket_cetalk_x86em_ce
...
nmake /NOLOGO /f "CEtalk.vcn" CFG="CEtalk - Win32 (WCE x86em) Release Italian" CESubsystem=windowsce,3.00 CEVersion=300 CEConfigName="Pocket PC"
if NOT exist .\%build_static%\x86em\it\release\dtalk_it.exe echo Workspace %blddrv%%bldpath%\samplece\cetalk\cetalk.vcn wce300 Pocket PC Win32 (WCE X86EM) Release Italian not build >> %blddrv%%bldpath%\build_log\errors\win_ce%index%.log
:wce300_pocket_cetalk_x86em_ce

rem if "%bug_x86em_cedll%"=="1" goto wce300_pocket_cetalk_x86em_cedll
...
nmake /NOLOGO /f "CEtalk.vcn" CFG="CEtalk - Win32 (WCE x86em) Release Italian dll" CESubsystem=windowsce,3.00 CEVersion=300 CEConfigName="Pocket PC"
if NOT exist .\%build_dll%\x86em\it\release\dtalk_it.exe echo Workspace %blddrv%%bldpath%\samplece\cetalk\cetalk.vcn wce300 Pocket PC Win32 (WCE X86EM) Release Italian Dll not build >> %blddrv%%bldpath%\build_log\errors\win_ce%index%.log
...
rem if "%bug_arm_ce%"=="1" goto wce300_pocket_mailread_arm_ce
...
rem if "%bug_arm_cedll%"=="1" goto wce300_pocket_mailread_arm_cedll
...
rem if "%bug_mips_ce%"=="1" goto wce300_pocket_mailread_mips_ce
...
rem if "%bug_mips_cedll%"=="1" goto wce300_pocket_mailread_mips_cedll
...
rem if "%bug_sh_ce%"=="1" goto wce300_pocket_mailread_sh_ce
...
rem if "%bug_sh_cedll%"=="1" goto wce300_pocket_mailread_sh_cedll
...
rem if "%bug_x86em_ce%"=="1" goto wce300_pocket_mailread_x86em_ce
...
rem if "%bug_x86em_cedll%"=="1" goto wce300_pocket_mailread_x86em_cedll
...
move .\dapi\build\cedllvb  .\dapi\build\%PLATFORM%\pocket
...
if exist .\dapi\build\%PLATFORM%\2000\cedllvb 					move .\dapi\build\%PLATFORM%\2000\cedllvb					.\dapi\build\cedllvb
...
if NOT exist ..\%build_wce_static%\arm\gr\release\dtstatic.lib set bug_arm_ce=1
nmake /NOLOGO /f "ce.vcn" CFG="CE - Win32 (WCE ARM) Release Italian" CESubsystem=windowsce,3.00 CEVersion=300 CEConfigName="HPC 2000"
if NOT exist ..\%build_wce_static%\arm\it\release\dtstatic.lib echo Workspace %blddrv%%bldpath%\dapi\src\ce.vcn wce300 HPC 2000 Win32 (WCE ARM) Release Italian not build >> %blddrv%%bldpath%\build_log\errors\win_ce%index%.log
if NOT exist ..\%build_wce_static%\arm\it\release\dtstatic.lib set bug_arm_ce=1
...
if NOT exist ..\%build_wce_dll%\arm\gr\release\dectalk.dll set bug_arm_cedll=1
nmake /NOLOGO /f "cedll.vcn" CFG="cedll - Win32 (WCE ARM) Release Italian" CESubsystem=windowsce,3.00 CEVersion=300 CEConfigName="HPC 2000"
if NOT exist ..\%build_wce_dll%\arm\it\release\dectalk.dll echo Workspace %blddrv%%bldpath%\dapi\src\cedll.vcn wce300 HPC 2000 Win32 (WCE ARM) Release Italian not build >> %blddrv%%bldpath%\build_log\errors\win_ce%index%.log
if NOT exist ..\%build_wce_dll%\arm\it\release\dectalk.dll set bug_arm_cedll=1

nmake /NOLOGO /f "cedllvb.vcn" CFG="cedllvb - Win32 (WCE ARM) Release" CESubsystem=windowsce,3.00 CEVersion=300 CEConfigName="HPC 2000"
if NOT exist ..\%build_wce_dllvb%\arm\us\release\dectalkvb.dll echo Workspace %blddrv%%bldpath%\dapi\src\cedllvb.vcn wce300 HPC 2000 Win32 (WCE ARM) Release not build >> %blddrv%%bldpath%\build_log\errors\win_ce%index%.log
if NOT exist ..\%build_wce_dllvb%\arm\us\release\dectalkvb.dll set bug_arm_cedllvb=1
nmake /NOLOGO /f "cedllvb.vcn" CFG="cedllvb - Win32 (WCE ARM) Release Spanish" CESubsystem=windowsce,3.00 CEVersion=300 CEConfigName="HPC 2000"
if NOT exist ..\%build_wce_dllvb%\arm\us\release\dectalkvb.dll echo Workspace %blddrv%%bldpath%\dapi\src\cedllvb.vcn wce300 HPC 2000 Win32 (WCE ARM) Release Spanish not build >> %blddrv%%bldpath%\build_log\errors\win_ce%index%.log
if NOT exist ..\%build_wce_dllvb%\arm\us\release\dectalkvb.dll set bug_arm_cedllvb=1
nmake /NOLOGO /f "cedllvb.vcn" CFG="cedllvb - Win32 (WCE ARM) Release Latin American" CESubsystem=windowsce,3.00 CEVersion=300 CEConfigName="HPC 2000"
if NOT exist ..\%build_wce_dllvb%\arm\us\release\dectalkvb.dll echo Workspace %blddrv%%bldpath%\dapi\src\cedllvb.vcn wce300 HPC 2000 Win32 (WCE ARM) Release Latin American not build >> %blddrv%%bldpath%\build_log\errors\win_ce%index%.log
if NOT exist ..\%build_wce_dllvb%\arm\us\release\dectalkvb.dll set bug_arm_cedllvb=1
nmake /NOLOGO /f "cedllvb.vcn" CFG="cedllvb - Win32 (WCE ARM) Release English UK" CESubsystem=windowsce,3.00 CEVersion=300 CEConfigName="HPC 2000"
if NOT exist ..\%build_wce_dllvb%\arm\us\release\dectalkvb.dll echo Workspace %blddrv%%bldpath%\dapi\src\cedllvb.vcn wce300 HPC 2000 Win32 (WCE ARM) Release English UK not build >> %blddrv%%bldpath%\build_log\errors\win_ce%index%.log
if NOT exist ..\%build_wce_dllvb%\arm\us\release\dectalkvb.dll set bug_arm_cedllvb=1
nmake /NOLOGO /f "cedllvb.vcn" CFG="cedllvb - Win32 (WCE ARM) Release French" CESubsystem=windowsce,3.00 CEVersion=300 CEConfigName="HPC 2000"
if NOT exist ..\%build_wce_dllvb%\arm\us\release\dectalkvb.dll echo Workspace %blddrv%%bldpath%\dapi\src\cedllvb.vcn wce300 HPC 2000 Win32 (WCE ARM) Release French not build >> %blddrv%%bldpath%\build_log\errors\win_ce%index%.log
if NOT exist ..\%build_wce_dllvb%\arm\us\release\dectalkvb.dll set bug_arm_cedllvb=1
nmake /NOLOGO /f "cedllvb.vcn" CFG="cedllvb - Win32 (WCE ARM) Release German" CESubsystem=windowsce,3.00 CEVersion=300 CEConfigName="HPC 2000"
if NOT exist ..\%build_wce_dllvb%\arm\us\release\dectalkvb.dll echo Workspace %blddrv%%bldpath%\dapi\src\cedllvb.vcn wce300 HPC 2000 Win32 (WCE ARM) Release German not build >> %blddrv%%bldpath%\build_log\errors\win_ce%index%.log
if NOT exist ..\%build_wce_dllvb%\arm\us\release\dectalkvb.dll set bug_arm_cedllvb=1
nmake /NOLOGO /f "cedllvb.vcn" CFG="cedllvb - Win32 (WCE ARM) Release Italian" CESubsystem=windowsce,3.00 CEVersion=300 CEConfigName="HPC 2000"
if NOT exist ..\%build_wce_dllvb%\arm\us\release\dectalkvb.dll echo Workspace %blddrv%%bldpath%\dapi\src\cedllvb.vcn wce300 HPC 2000 Win32 (WCE ARM) Release Italian not build >> %blddrv%%bldpath%\build_log\errors\win_ce%index%.log
if NOT exist ..\%build_wce_dllvb%\arm\us\release\dectalkvb.dll set bug_arm_cedllvb=1
...
rem nmake /NOLOGO /f "cedll.vcn" CFG="cedll - Win32 (WCE ARM) Access32 Italian" CESubsystem=windowsce,3.00 CEVersion=300 CEConfigName="HPC 2000"
rem if NOT exist ..\%build_wce_dll%\arm\it\access32\dectalk.dll echo Workspace %blddrv%%bldpath%\dapi\src\cedll.vcn wce300 HPC 2000 Win32 (WCE ARM) Access32 Italian not build >> %blddrv%%bldpath%\build_log\errors\win_ce%index%.log
rem if NOT exist ..\%build_wce_dll%\arm\it\access32\dectalk.dll set bug_arm_cedll=1
...
if NOT exist ..\%build_wce_static%\mips\gr\release\dtstatic.lib set bug_mips_ce=1
nmake /NOLOGO /f "ce.vcn" CFG="CE - Win32 (WCE MIPS) Release Italian" CESubsystem=windowsce,3.00 CEVersion=300 CEConfigName="HPC 2000"
if NOT exist ..\%build_wce_static%\mips\it\release\dtstatic.lib echo Workspace %blddrv%%bldpath%\dapi\src\ce.vcn wce300 HPC 2000 Win32 (WCE MIPS) Release Italian not build >> %blddrv%%bldpath%\build_log\errors\win_ce%index%.log
if NOT exist ..\%build_wce_static%\mips\it\release\dtstatic.lib set bug_mips_ce=1
...
if NOT exist ..\%build_wce_dll%\mips\gr\release\dectalk.dll set bug_mips_cedll=1
nmake /NOLOGO /f "cedll.vcn" CFG="cedll - Win32 (WCE MIPS) Release Italian" CESubsystem=windowsce,3.00 CEVersion=300 CEConfigName="HPC 2000"
if NOT exist ..\%build_wce_dll%\mips\it\release\dectalk.dll echo Workspace %blddrv%%bldpath%\dapi\src\cedll.vcn wce300 HPC 2000 Win32 (WCE MIPS) Release Italian not build >> %blddrv%%bldpath%\build_log\errors\win_ce%index%.log
if NOT exist ..\%build_wce_dll%\mips\it\release\dectalk.dll set bug_mips_cedll=1

nmake /NOLOGO /f "cedllvb.vcn" CFG="cedllvb - Win32 (WCE MIPS) Release" CESubsystem=windowsce,3.00 CEVersion=300 CEConfigName="HPC 2000"
if NOT exist ..\%build_wce_dllvb%\mips\us\release\dectalkvb.dll echo Workspace %blddrv%%bldpath%\dapi\src\cedllvb.vcn wce300 HPC 2000 Win32 (WCE MIPS) Release not build >> %blddrv%%bldpath%\build_log\errors\win_ce%index%.log
if NOT exist ..\%build_wce_dllvb%\mips\us\release\dectalkvb.dll set bug_mips_cedllvb=1
nmake /NOLOGO /f "cedllvb.vcn" CFG="cedllvb - Win32 (WCE MIPS) Release Spanish" CESubsystem=windowsce,3.00 CEVersion=300 CEConfigName="HPC 2000"
if NOT exist ..\%build_wce_dllvb%\mips\us\release\dectalkvb.dll echo Workspace %blddrv%%bldpath%\dapi\src\cedllvb.vcn wce300 HPC 2000 Win32 (WCE MIPS) Release Spanish not build >> %blddrv%%bldpath%\build_log\errors\win_ce%index%.log
if NOT exist ..\%build_wce_dllvb%\mips\us\release\dectalkvb.dll set bug_mips_cedllvb=1
nmake /NOLOGO /f "cedllvb.vcn" CFG="cedllvb - Win32 (WCE MIPS) Release Latin American" CESubsystem=windowsce,3.00 CEVersion=300 CEConfigName="HPC 2000"
if NOT exist ..\%build_wce_dllvb%\mips\us\release\dectalkvb.dll echo Workspace %blddrv%%bldpath%\dapi\src\cedllvb.vcn wce300 HPC 2000 Win32 (WCE MIPS) Release Latin American not build >> %blddrv%%bldpath%\build_log\errors\win_ce%index%.log
if NOT exist ..\%build_wce_dllvb%\mips\us\release\dectalkvb.dll set bug_mips_cedllvb=1
nmake /NOLOGO /f "cedllvb.vcn" CFG="cedllvb - Win32 (WCE MIPS) Release English UK" CESubsystem=windowsce,3.00 CEVersion=300 CEConfigName="HPC 2000"
if NOT exist ..\%build_wce_dllvb%\mips\us\release\dectalkvb.dll echo Workspace %blddrv%%bldpath%\dapi\src\cedllvb.vcn wce300 HPC 2000 Win32 (WCE MIPS) Release English UK not build >> %blddrv%%bldpath%\build_log\errors\win_ce%index%.log
if NOT exist ..\%build_wce_dllbv%\mips\us\release\dectalkvb.dll set bug_mips_cedllvb=1
nmake /NOLOGO /f "cedllvb.vcn" CFG="cedllvb - Win32 (WCE MIPS) Release French" CESubsystem=windowsce,3.00 CEVersion=300 CEConfigName="HPC 2000"
if NOT exist ..\%build_wce_dllvb%\mips\us\release\dectalkvb.dll echo Workspace %blddrv%%bldpath%\dapi\src\cedllvb.vcn wce300 HPC 2000 Win32 (WCE MIPS) Release French not build >> %blddrv%%bldpath%\build_log\errors\win_ce%index%.log
if NOT exist ..\%build_wce_dllvb%\mips\us\release\dectalkvb.dll set bug_mips_cedllvb=1
nmake /NOLOGO /f "cedllvb.vcn" CFG="cedllvb - Win32 (WCE MIPS) Release German" CESubsystem=windowsce,3.00 CEVersion=300 CEConfigName="HPC 2000"
if NOT exist ..\%build_wce_dllvb%\mips\us\release\dectalkvb.dll echo Workspace %blddrv%%bldpath%\dapi\src\cedllvb.vcn wce300 HPC 2000 Win32 (WCE MIPS) Release German not build >> %blddrv%%bldpath%\build_log\errors\win_ce%index%.log
if NOT exist ..\%build_wce_dllvb%\mips\us\release\dectalkvb.dll set bug_mips_cedllvb=1
nmake /NOLOGO /f "cedllvb.vcn" CFG="cedllvb - Win32 (WCE MIPS) Release Italian" CESubsystem=windowsce,3.00 CEVersion=300 CEConfigName="HPC 2000"
if NOT exist ..\%build_wce_dllvb%\mips\us\release\dectalkvb.dll echo Workspace %blddrv%%bldpath%\dapi\src\cedllvb.vcn wce300 HPC 2000 Win32 (WCE MIPS) Release Italian not build >> %blddrv%%bldpath%\build_log\errors\win_ce%index%.log
if NOT exist ..\%build_wce_dllvb%\mips\us\release\dectalkvb.dll set bug_mips_cedllvb=1
...
rem nmake /NOLOGO /f "cedll.vcn" CFG="cedll - Win32 (WCE MIPS) Access32 Italian" CESubsystem=windowsce,3.00 CEVersion=300 CEConfigName="H/PC Pro 2.11"
rem if NOT exist ..\%build_wce_dll%\mips\it\access32\dectalk.dll echo Workspace %blddrv%%bldpath%\dapi\src\cedll.vcn wce300 HPC 2000 Win32 (WCE MIPS) Access32 Italian not build >> %blddrv%%bldpath%\build_log\errors\win_ce%index%.log
rem if NOT exist ..\%build_wce_dll%\mips\it\access32\dectalk.dll set bug_mips_cedll=1
...
nmake /NOLOGO /f "ce.vcn" CFG="CE - Win32 (WCE x86) Release Italian" CESubsystem=windowsce,3.00 CEVersion=300 CEConfigName="HPC 2000"
if NOT exist ..\%build_wce_static%\x86\it\release\dtstatic.lib echo Workspace %blddrv%%bldpath%\dapi\src\ce.vcn wce300 HPC 2000 Win32 (WCE x86) Release Italian not build >> %blddrv%%bldpath%\build_log\errors\win_ce%index%.log
if NOT exist ..\%build_wce_static%\x86\it\release\dtstatic.lib set bug_x86_ce=1
...
nmake /NOLOGO /f "cedll.vcn" CFG="cedll - Win32 (WCE x86) Release Italian" CESubsystem=windowsce,3.00 CEVersion=300 CEConfigName="HPC 2000"
if NOT exist ..\%build_wce_dll%\x86\it\release\dectalk.dll echo Workspace %blddrv%%bldpath%\dapi\src\cedll.vcn wce300 HPC 2000 Win32 (WCE x86) Release Italian not build >> %blddrv%%bldpath%\build_log\errors\win_ce%index%.log
if NOT exist ..\%build_wce_dll%\x86\it\release\dectalk.dll set bug_x86_cedll=1

nmake /NOLOGO /f "cedllvb.vcn" CFG="cedllvb - Win32 (WCE x86) Release" CESubsystem=windowsce,3.00 CEVersion=300 CEConfigName="HPC 2000"
if NOT exist ..\%build_wce_dllvb%\x86\us\release\dectalkvb.dll echo Workspace %blddrv%%bldpath%\dapi\src\cedllvb.vcn wce300 HPC 2000 Win32 (WCE x86) Release not build >> %blddrv%%bldpath%\build_log\errors\win_ce%index%.log
if NOT exist ..\%build_wce_dllvb%\x86\us\release\dectalkvb.dll set bug_x86_cedllvb=1
nmake /NOLOGO /f "cedllvb.vcn" CFG="cedllvb - Win32 (WCE x86) Release Spanish" CESubsystem=windowsce,3.00 CEVersion=300 CEConfigName="HPC 2000"
if NOT exist ..\%build_wce_dllvb%\x86\us\release\dectalkvb.dll echo Workspace %blddrv%%bldpath%\dapi\src\cedllvb.vcn wce300 HPC 2000 Win32 (WCE x86) Release Spanish not build >> %blddrv%%bldpath%\build_log\errors\win_ce%index%.log
if NOT exist ..\%build_wce_dllvb%\x86\us\release\dectalkvb.dll set bug_x86_cedllvb=1
nmake /NOLOGO /f "cedllvb.vcn" CFG="cedllvb - Win32 (WCE x86) Release Latin American" CESubsystem=windowsce,3.00 CEVersion=300 CEConfigName="HPC 2000"
if NOT exist ..\%build_wce_dllvb%\x86\us\release\dectalkvb.dll echo Workspace %blddrv%%bldpath%\dapi\src\cedllvb.vcn wce300 HPC 2000 Win32 (WCE x86) Release Latin American not build >> %blddrv%%bldpath%\build_log\errors\win_ce%index%.log
if NOT exist ..\%build_wce_dllvb%\x86\us\release\dectalkvb.dll set bug_x86_cedllvb=1
nmake /NOLOGO /f "cedllvb.vcn" CFG="cedllvb - Win32 (WCE x86) Release English UK" CESubsystem=windowsce,3.00 CEVersion=300 CEConfigName="HPC 2000"
if NOT exist ..\%build_wce_dllvb%\x86\us\release\dectalkvb.dll echo Workspace %blddrv%%bldpath%\dapi\src\cedllvb.vcn wce300 HPC 2000 Win32 (WCE x86) Release English UK not build >> %blddrv%%bldpath%\build_log\errors\win_ce%index%.log
if NOT exist ..\%build_wce_dllvb%\x86\us\release\dectalkvb.dll set bug_x86_cedllvb=1
nmake /NOLOGO /f "cedllvb.vcn" CFG="cedllvb - Win32 (WCE x86) Release French" CESubsystem=windowsce,3.00 CEVersion=300 CEConfigName="HPC 2000"
if NOT exist ..\%build_wce_dllvb%\x86\us\release\dectalkvb.dll echo Workspace %blddrv%%bldpath%\dapi\src\cedllvb.vcn wce300 HPC 2000 Win32 (WCE x86) Release French not build >> %blddrv%%bldpath%\build_log\errors\win_ce%index%.log
if NOT exist ..\%build_wce_dllvb%\x86\us\release\dectalkvb.dll set bug_x86_cedllvb=1
nmake /NOLOGO /f "cedllvb.vcn" CFG="cedllvb - Win32 (WCE x86) Release German" CESubsystem=windowsce,3.00 CEVersion=300 CEConfigName="HPC 2000"
if NOT exist ..\%build_wce_dllvb%\x86\us\release\dectalkvb.dll echo Workspace %blddrv%%bldpath%\dapi\src\cedllvb.vcn wce300 HPC 2000 Win32 (WCE x86) Release German not build >> %blddrv%%bldpath%\build_log\errors\win_ce%index%.log
if NOT exist ..\%build_wce_dllvb%\x86\us\release\dectalkvb.dll set bug_x86_cedllvb=1
nmake /NOLOGO /f "cedllvb.vcn" CFG="cedllvb - Win32 (WCE x86) Release Italian" CESubsystem=windowsce,3.00 CEVersion=300 CEConfigName="HPC 2000"
if NOT exist ..\%build_wce_dllvb%\x86\us\release\dectalkvb.dll echo Workspace %blddrv%%bldpath%\dapi\src\cedllvb.vcn wce300 HPC 2000 Win32 (WCE x86) Release Italian not build >> %blddrv%%bldpath%\build_log\errors\win_ce%index%.log
if NOT exist ..\%build_wce_dllvb%\x86\us\release\dectalkvb.dll set bug_x86_cedllvb=1
...
rem if "%bug_arm_ce%"=="1" goto wce300_2000_dtsample_arm_ce
...
nmake /NOLOGO /f "Dtsample.vcn" CFG="Dtsample - Win32 (WCE ARM) Release Italian" CESubsystem=windowsce,3.00 CEVersion=300 CEConfigName="HPC 2000"
if NOT exist .\%build_static%\arm\it\release\dtsample.exe echo Workspace %blddrv%%bldpath%\samplece\dtsample\dtsample.vcn wce300 HPC 2000 Win32 (WCE ARM) Release Italian not build >> %blddrv%%bldpath%\build_log\errors\win_ce%index%.log
:wce300_2000_dtsample_arm_ce

rem if "%bug_arm_cedll%"=="1" goto wce300_2000_dtsample_arm_cedll
...
nmake /NOLOGO /f "Dtsample.vcn" CFG="Dtsample - Win32 (WCE ARM) Release Italian dll" CESubsystem=windowsce,3.00 CEVersion=300 CEConfigName="HPC 2000"
if NOT exist .\%build_dll%\arm\it\release\dtsample.exe echo Workspace %blddrv%%bldpath%\samplece\dtsample\dtsample.vcn wce300 HPC 2000 Win32 (WCE ARM) Release Italian Dll not build >> %blddrv%%bldpath%\build_log\errors\win_ce%index%.log
:wce300_2000_dtsample_arm_cedll

set LIB=%DEVROOT%\%PLATFORM%\hpc2000\lib\MIPS;%DEVROOT%\%PLATFORM%\hpc2000\mfc\lib\MIPS;

rem if "%bug_mips_ce%"=="1" goto wce300_2000_dtsample_mips_ce
...
nmake /NOLOGO /f "Dtsample.vcn" CFG="Dtsample - Win32 (WCE MIPS) Release Italian" CESubsystem=windowsce,3.00 CEVersion=300 CEConfigName="HPC 2000"
if NOT exist .\%build_static%\mips\it\release\dtsample.exe echo Workspace %blddrv%%bldpath%\samplece\dtsample\dtsample.vcn wce300 HPC 2000 Win32 (WCE MIPS) Release Italian not build >> %blddrv%%bldpath%\build_log\errors\win_ce%index%.log
:wce300_2000_dtsample_mips_ce

rem if "%bug_mips_cedll%"=="1" goto wce300_2000_dtsample_mips_cedll
...
nmake /NOLOGO /f "Dtsample.vcn" CFG="Dtsample - Win32 (WCE MIPS) Release Italian Dll" CESubsystem=windowsce,3.00 CEVersion=300 CEConfigName="HPC 2000"
if NOT exist .\%build_dll%\mips\it\release\dtsample.exe echo Workspace %blddrv%%bldpath%\samplece\dtsample\dtsample.vcn wce300 HPC 2000 Win32 (WCE MIPS) Release Italian Dll not build >> %blddrv%%bldpath%\build_log\errors\win_ce%index%.log
:wce300_2000_dtsample_mips_cedll

set LIB=%DEVROOT%\%PLATFORM%\hpc2000\lib\x86;%DEVROOT%\%PLATFORM%\hpc2000\mfc\lib\x86;

rem if "%bug_x86_ce%"=="1" goto wce300_2000_dtsample_x86_ce
...
nmake /NOLOGO /f "Dtsample.vcn" CFG="Dtsample - Win32 (WCE x86) Release Italian" CESubsystem=windowsce,3.00 CEVersion=300 CEConfigName="HPC 2000"
if NOT exist .\%build_static%\x86\it\release\dtsample.exe echo Workspace %blddrv%%bldpath%\samplece\dtsample\dtsample.vcn wce300 HPC 2000 Win32 (WCE x86) Release Italian not build >> %blddrv%%bldpath%\build_log\errors\win_ce%index%.log
:wce300_2000_dtsample_x86_ce

rem if "%bug_x86_cedll%"=="1" goto wce300_2000_dtsample_x86_cedll
...
nmake /NOLOGO /f "Dtsample.vcn" CFG="Dtsample - Win32 (WCE x86) Release Italian Dll" CESubsystem=windowsce,3.00 CEVersion=300 CEConfigName="HPC 2000"
if NOT exist .\%build_dll%\x86\it\release\dtsample.exe echo Workspace %blddrv%%bldpath%\samplece\dtsample\dtsample.vcn wce300 HPC 2000 Win32 (WCE x86) Release Italian Dll not build >> %blddrv%%bldpath%\build_log\errors\win_ce%index%.log
...
rem if "%bug_arm_ce%"=="1" goto wce300_2000_cetalk_arm_ce
...
nmake /NOLOGO /f "CEtalk.vcn" CFG="CEtalk - Win32 (WCE ARM) Release Italian" CESubsystem=windowsce,3.00 CEVersion=300 CEConfigName="HPC 2000"
if NOT exist .\%build_static%\arm\it\release\dtalk_it.exe echo Workspace %blddrv%%bldpath%\samplece\cetalk\cetalk.vcn wce300 HPC 2000 Win32 (WCE ARM) Release Italian not build >> %blddrv%%bldpath%\build_log\errors\win_ce%index%.log
:wce300_2000_cetalk_arm_ce

rem if "%bug_arm_cedll%"=="1" goto wce300_2000_cetalk_arm_cedll
...
nmake /NOLOGO /f "CEtalk.vcn" CFG="CEtalk - Win32 (WCE ARM) Release Italian dll" CESubsystem=windowsce,3.00 CEVersion=300 CEConfigName="HPC 2000"
if NOT exist .\%build_dll%\arm\it\release\dtalk_it.exe echo Workspace %blddrv%%bldpath%\samplece\cetalk\cetalk.vcn wce300 HPC 2000 Win32 (WCE ARM) Release Italian Dll not build >> %blddrv%%bldpath%\build_log\errors\win_ce%index%.log
:wce300_2000_cetalk_arm_cedll

set LIB=%DEVROOT%\%PLATFORM%\hpc2000\lib\MIPS;%DEVROOT%\%PLATFORM%\hpc2000\mfc\lib\MIPS;

rem if "%bug_mips_ce%"=="1" goto wce300_2000_cetalk_mips_ce
...
nmake /NOLOGO /f "CEtalk.vcn" CFG="CEtalk - Win32 (WCE MIPS) Release Italian" CESubsystem=windowsce,3.00 CEVersion=300 CEConfigName="HPC 2000"
if NOT exist .\%build_static%\mips\it\release\dtalk_it.exe echo Workspace %blddrv%%bldpath%\samplece\cetalk\cetalk.vcn wce300 HPC 2000 Win32 (WCE MIPS) Release Italian not build >> %blddrv%%bldpath%\build_log\errors\win_ce%index%.log
:wce300_2000_cetalk_mips_ce

rem if "%bug_mips_cedll%"=="1" goto wce300_2000_cetalk_mips_cedll
...
nmake /NOLOGO /f "CEtalk.vcn" CFG="CEtalk - Win32 (WCE MIPS) Release Italian dll" CESubsystem=windowsce,3.00 CEVersion=300 CEConfigName="HPC 2000"
if NOT exist .\%build_dll%\mips\it\release\dtalk_it.exe echo Workspace %blddrv%%bldpath%\samplece\cetalk\cetalk.vcn wce300 HPC 2000 Win32 (WCE MIPS) Release Italian Dll not build >> %blddrv%%bldpath%\build_log\errors\win_ce%index%.log
:wce300_2000_cetalk_mips_cedll

set LIB=%DEVROOT%\%PLATFORM%\hpc2000\lib\x86;%DEVROOT%\%PLATFORM%\hpc2000\mfc\lib\x86;

rem if "%bug_x86_ce%"=="1" goto wce300_2000_cetalk_x86_ce
...
nmake /NOLOGO /f "CEtalk.vcn" CFG="CEtalk - Win32 (WCE x86) Release Italian" CESubsystem=windowsce,3.00 CEVersion=300 CEConfigName="HPC 2000"
if NOT exist .\%build_static%\x86\it\release\dtalk_it.exe echo Workspace %blddrv%%bldpath%\samplece\cetalk\cetalk.vcn wce300 HPC 2000 Win32 (WCE x86) Release Italian not build >> %blddrv%%bldpath%\build_log\errors\win_ce%index%.log
:wce300_2000_cetalk_x86_ce

rem if "%bug_x86_cedll%"=="1" goto wce300_2000_cetalk_x86_cedll
...
nmake /NOLOGO /f "CEtalk.vcn" CFG="CEtalk - Win32 (WCE x86) Release Italian dll" CESubsystem=windowsce,3.00 CEVersion=300 CEConfigName="HPC 2000"
if NOT exist .\%build_dll%\x86\it\release\dtalk_it.exe echo Workspace %blddrv%%bldpath%\samplece\cetalk\cetalk.vcn wce300 HPC 2000 Win32 (WCE x86) Release Italian Dll not build >> %blddrv%%bldpath%\build_log\errors\win_ce%index%.log
...
rem if "%bug_arm_ce%"=="1" goto wce300_2000_mailread_arm_ce
...
rem if "%bug_arm_cedll%"=="1" goto wce300_2000_mailread_arm_cedll
...
rem if "%bug_mips_ce%"=="1" goto wce300_2000_mailread_mips_ce
...
rem if "%bug_mips_cedll%"=="1" goto wce300_2000_mailread_mips_cedll
...
rem if "%bug_x86_ce%"=="1" goto wce300_2000_mailread_x86_ce
...
rem if "%bug_x86_cedll%"=="1" goto wce300_2000_mailread_x86_cedll
...
move .\dapi\build\cedllvb  .\dapi\build\%PLATFORM%\2000
...
if NOT exist ..\%build_wce_static%\x86\gr\release\dtstatic.lib set bug_x86_ce=1
nmake /NOLOGO /f "ce.vcn" CFG="CE - Win32 (WCE x86) Release Italian" CESubsystem=windowsce,3.00 CEVersion=300 CEConfigName="SMARTMEDIA"
if NOT exist ..\%build_wce_static%\x86\it\release\dtstatic.lib echo Workspace %blddrv%%bldpath%\dapi\src\ce.vcn wce300 SMARTMEDIA Win32 (WCE x86) Release Italian not build >> %blddrv%%bldpath%\build_log\errors\win_ce%index%.log
if NOT exist ..\%build_wce_static%\x86\it\release\dtstatic.lib set bug_x86_ce=1
...
if NOT exist ..\%build_wce_dll%\x86\gr\release\dectalk.dll set bug_x86_cedll=1
nmake /NOLOGO /f "cedll.vcn" CFG="cedll - Win32 (WCE x86) Release Italian" CESubsystem=windowsce,3.00 CEVersion=300 CEConfigName="SMARTMEDIA"
if NOT exist ..\%build_wce_dll%\x86\it\release\dectalk.dll echo Workspace %blddrv%%bldpath%\dapi\src\cedll.vcn wce300 SMARTMEDIA Win32 (WCE x86) Release Italian not build >> %blddrv%%bldpath%\build_log\errors\win_ce%index%.log
if NOT exist ..\%build_wce_dll%\x86\it\release\dectalk.dll set bug_x86_cedll=1
...
rem if "%bug_x86_ce%"=="1" goto wce300_SMARTMEDIA_dtsample_x86_ce
...
nmake /NOLOGO /f "Dtsample.vcn" CFG="Dtsample - Win32 (WCE x86) Release Italian" CESubsystem=windowsce,3.00 CEVersion=300 CEConfigName="SMARTMEDIA"
if NOT exist .\%build_static%\x86\it\release\dtsample.exe echo Workspace %blddrv%%bldpath%\samplece\dtsample\dtsample.vcn wce300 SMARTMEDIA Win32 (WCE x86) Release Italian not build >> %blddrv%%bldpath%\build_log\errors\win_ce%index%.log
:wce300_SMARTMEDIA_dtsample_x86_ce

rem if "%bug_x86_cedll%"=="1" goto wce300_SMARTMEDIA_dtsample_x86_cedll
...
nmake /NOLOGO /f "Dtsample.vcn" CFG="Dtsample - Win32 (WCE x86) Release Italian Dll" CESubsystem=windowsce,3.00 CEVersion=300 CEConfigName="SMARTMEDIA"
if NOT exist .\%build_dll%\x86\it\release\dtsample.exe echo Workspace %blddrv%%bldpath%\samplece\dtsample\dtsample.vcn wce300 SMARTMEDIA Win32 (WCE x86) Release Italian Dll not build >> %blddrv%%bldpath%\build_log\errors\win_ce%index%.log
...
rem if "%bug_x86_ce%"=="1" goto wce300_SMARTMEDIA_cetalk_x86_ce
...
nmake /NOLOGO /f "CEtalk.vcn" CFG="CEtalk - Win32 (WCE x86) Release Italian" CESubsystem=windowsce,3.00 CEVersion=300 CEConfigName="SMARTMEDIA"
if NOT exist .\%build_static%\x86\it\release\dtalk_it.exe echo Workspace %blddrv%%bldpath%\samplece\cetalk\cetalk.vcn wce300 SMARTMEDIA Win32 (WCE x86) Release Italian not build >> %blddrv%%bldpath%\build_log\errors\win_ce%index%.log
:wce300_SMARTMEDIA_cetalk_x86_ce

rem if "%bug_x86_cedll%"=="1" goto wce300_SMARTMEDIA_cetalk_x86_cedll
...
nmake /NOLOGO /f "CEtalk.vcn" CFG="CEtalk - Win32 (WCE x86) Release Italian dll" CESubsystem=windowsce,3.00 CEVersion=300 CEConfigName="SMARTMEDIA"
if NOT exist .\%build_dll%\x86\it\release\dtalk_it.exe echo Workspace %blddrv%%bldpath%\samplece\cetalk\cetalk.vcn wce300 SMARTMEDIA Win32 (WCE x86) Release Italian Dll not build >> %blddrv%%bldpath%\build_log\errors\win_ce%index%.log
...
rem if "%bug_x86_ce%"=="1" goto wce300_SMARTMEDIA_mailread_x86_ce
...
rem if "%bug_x86_cedll%"=="1" goto wce300_SMARTMEDIA_mailread_x86_cedll
