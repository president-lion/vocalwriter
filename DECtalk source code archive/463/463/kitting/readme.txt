DECtalk(r) Software Version 4.63
Release Identifier: V4.63 R003
README.TXT
December 2004.

KITS SUPPORTED:

This README file applies to one of the following DECtalk V4.63 R003
...
WHAT'S NEW IN DECTALK SOFTWARE V4.63 ?

DECtalk Software V4.63 contains the following new features:
...
from 	HKEY_LOCAL_MACHINE\SOFTWARE\DECtalk Software\DECtalk\4.62

to 	HKEY_LOCAL_MACHINE\SOFTWARE\DECtalk Software\DECtalk\4.63. 
...
Copyright (c) 2001, 2002, 2003, 2004 by Fonix  Corporation.
