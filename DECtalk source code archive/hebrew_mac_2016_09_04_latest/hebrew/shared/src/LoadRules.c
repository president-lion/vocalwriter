...
SDWORD WriteRules(char *sRulesFile, Graph2PhonPtr pGraph2Phon)
{
   ...
   {
      if (iRuleSet==0)
         FNX_FPRINTF(fp, "Rule: punctuation\n");
      else FNX_FPRINTF(fp, "Rule: %c\n", pGraph2Phon->pRuleIndex[iRuleSet-1]);
