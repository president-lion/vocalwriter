...
#  define FNXW_BUILD_STRUPR
   ...
   ***********************************************************/
   FNX_EXPORT( wchar_t *, fnxwStrupr( wchar_t *string ) );
#endif
...
#  define FNXW_BUILD_ISASCII
   /***********************************************************
   Checks to see if a character is 7-bit ASCII
   [in]  c -- the character to check
   [out] true if in the range (0..127), false otherwise
   ***********************************************************/
   FNX_EXPORT( int, fnxwIsascii( wint_t c ) );
#endif
