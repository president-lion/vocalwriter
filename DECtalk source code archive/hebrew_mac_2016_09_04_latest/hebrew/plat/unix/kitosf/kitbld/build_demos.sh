...
tar czvf ../$1_demo_us.tar.gz ./*.txt ./*_us* ./demo.en ./demo.wav ./*.xpm

echo .
echo Making UK demo...
cp ../../build/speak/$VERSION/uk/release/gspeakdem_uk .
cp ../../../dapi/build/dic/$VERSION/uk/release/dtalk_uk.dic .
tar czvf ../$1_demo_uk.tar.gz ./*.txt ./*_uk* ./demo.uk ./demo.wav ./*.xpm

echo .
echo Making SP demo...
cp ../../build/speak/$VERSION/sp/release/gspeakdem_sp .
cp ../../../dapi/build/dic/$VERSION/sp/release/dtalk_sp.dic .
tar czvf ../$1_demo_sp.tar.gz ./*.txt ./*_sp* ./demo.sp ./demo.wav ./*.xpm

echo .
echo Making LA demo...
cp ../../build/speak/$VERSION/la/release/gspeakdem_la .
cp ../../../dapi/build/dic/$VERSION/la/release/dtalk_la.dic .
tar czvf ../$1_demo_la.tar.gz ./*.txt ./*_la* ./demo.la ./demo.wav ./*.xpm

echo .
echo Making GR demo...
cp ../../build/speak/$VERSION/gr/release/gspeakdem_gr .
cp ../../../dapi/build/dic/$VERSION/gr/release/dtalk_gr.dic .
tar czvf ../$1_demo_gr.tar.gz ./*.txt ./*_gr* ./demo.gr ./demo.wav ./*.xpm

echo .
echo Making FR demo...
cp ../../build/speak/$VERSION/fr/release/gspeakdem_fr .
cp ../../../dapi/build/dic/$VERSION/fr/release/dtalk_fr.dic .
tar czvf ../$1_demo_fr.tar.gz ./*.txt ./*_fr* ./demo.fr ./demo.wav ./*.xpm

echo .
echo Making IT demo...
cp ../../build/speak/$VERSION/it/release/gspeakdem_it .
cp ../../../dapi/build/dic/$VERSION/it/release/dtalk_it.dic .
tar czvf ../$1_demo_it.tar.gz ./*.txt ./*_it* ./demo.it ./demo.wav ./*.xpm

echo .
echo Making ALL demo...
tar czvf ../$1_demo_all.tar.gz ./*
