...
/skiff/local/bin/arm-linux-strip DECtalk/libtts*.so
...
/skiff/local/bin/arm-linux-strip ukenglish/libtts*.so
...
/skiff/local/bin/arm-linux-strip german/libtts*.so
...
/skiff/local/bin/arm-linux-strip spanish/libtts*.so
...
/skiff/local/bin/arm-linux-strip latinamerican/libtts*.so
...
/skiff/local/bin/arm-linux-strip french/libtts*.so
...
/skiff/local/bin/arm-linux-strip italian/libtts*.so
