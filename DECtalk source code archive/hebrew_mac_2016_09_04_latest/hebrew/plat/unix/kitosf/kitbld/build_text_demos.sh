...
tar cvf ../$1_demo_us.tar ./*.txt ./*_us* ./demo.en ./demo.wav 
gzip ../$1_demo_us.tar
...
tar cvf ../$1_demo_uk.tar ./*.txt ./*_uk* ./demo.uk ./demo.wav 
gzip ../$1_demo_uk.tar
...
tar cvf ../$1_demo_sp.tar ./*.txt ./*_sp* ./demo.sp ./demo.wav 
gzip ../$1_demo_sp.tar
...
tar cvf ../$1_demo_la.tar ./*.txt ./*_la* ./demo.la ./demo.wav 
gzip ../$1_demo_la.tar
...
tar cvf ../$1_demo_gr.tar ./*.txt ./*_gr* ./demo.gr ./demo.wav 
gzip ../$1_demo_gr.tar
...
tar cvf ../$1_demo_fr.tar ./*.txt ./*_fr* ./demo.fr ./demo.wav 
gzip ../$1_demo_fr.tar

echo .
echo Making it demo...
cp ../../build/dtsamples/$VERSION/it/release/say_demo_it .
cp ../../build/dtsamples/$VERSION/it/release/dtmemory_demo_it .
cp ../../../dapi/build/dic/$VERSION/it/release/dtalk_it.dic .
tar cvf ../$1_demo_it.tar ./*.txt ./*_it* ./demo.it ./demo.wav 
gzip ../$1_demo_it.tar

echo .
echo Making ALL demo...
tar cvf ../$1_demo_all.tar ./*
gzip ../$1_demo_all.tar
