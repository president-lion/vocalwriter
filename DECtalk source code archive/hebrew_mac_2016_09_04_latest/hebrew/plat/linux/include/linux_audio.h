...
#define DPRINTF(format, args...) FNX_FPRINTF(stddeb, format, ## args)
...
#define mallocLock( a ) FNX_MALLOC( a )
#define freeLock( b ) FNX_FREE( b )
...
#define SEGPTR_NEW(type) FNX_MALLOC(sizeof(type))
