...
#define	DCS_NAME_WENDY			SKIP_ESCAPE+8
#define	DCS_NAME_ED		 		SKIP_ESCAPE+9
#define	DCS_NAME_MATT	 		SKIP_ESCAPE+10
#define	DCS_NAME_SUE	 		SKIP_ESCAPE+11
#define	DCS_NAME_MARY	 		SKIP_ESCAPE+12
#define	DCS_NAME_LYNN	 		SKIP_ESCAPE+13
#define	DCS_NAME_TOM	 		SKIP_ESCAPE+14
#define	DCS_NAME_IVAN	 		SKIP_ESCAPE+15
#define	DCS_NAME_CHARLINE		SKIP_ESCAPE+16
#define	DCS_NAME_ARLENE	 		SKIP_ESCAPE+17
#define	DCS_NAME_VAL			SKIP_ESCAPE+18
#define	DCS_COMMA				202
#define	DCS_PERIOD				203
#define	DCS_LATIN				SKIP_ESCAPE+19
#define	DCS_NAME_CHRIS			SKIP_ESCAPE+20
...
#define DCS_INDEX_REPLACE_START	31 // its not an index, just a cheezy way to get the noise on and off
#define DCS_INDEX_REPLACE_END	32 // its not an index, just a cheezy way to get the noise on and off
//#endif	//_win32
