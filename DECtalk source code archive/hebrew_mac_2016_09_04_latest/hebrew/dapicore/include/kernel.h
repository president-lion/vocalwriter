...
//moved to port.h for platform specific stuff - mlt
...
#define LANG_korean				0x0008
#define LANG_chinese			0x0009
#define LANG_hebrew				0x000A
#define LANG_none               0xffff

#ifndef ARM7
#define MAX_languages           11
#else
#ifdef EPSON_ARM7
#define MAX_languages           11
#else
...
// These are now in DTFnxExStdlib.h for each platform - mlt
//void _far *malloc();
...
//moved to fnxexstdlib for each platform - mlt
/*
