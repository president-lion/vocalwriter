...
/* GL 04/21/1997  add this as the latest OSF code */
#if defined _UNIX_LIKE_ //(__osf__) /* don't put linux here */
...
MMRESULT TextToSpeechStartupEx( LPTTS_HANDLE_T * pphTTS, UINT, DWORD, 
							    VOID (*DtCallbackRoutine)(LONG, LONG, VOID *, UINT),
								VOID * );

MMRESULT TextToSpeechStartupExFonix( LPTTS_HANDLE_T * pphTTS, UINT, DWORD,
									 VOID (*DtCallbackRoutine)(LONG, LONG, VOID *, UINT),
									 VOID *, TCHAR *);
MMRESULT TextToSpeechStartupExFonixA( LPTTS_HANDLE_T * pphTTS, UINT, DWORD,
									 VOID (*DtCallbackRoutine)(LONG, LONG, VOID *, UINT),
									 VOID *, char *);
...
MMRESULT TextToSpeechSpeakA( LPTTS_HANDLE_T, LPSTR, DWORD );
MMRESULT TextToSpeechSpeakW( LPTTS_HANDLE_T, LPWSTR, DWORD );

MMRESULT TextToSpeechOpenWaveOutFile( LPTTS_HANDLE_T, TCHAR *, DWORD );
MMRESULT TextToSpeechOpenWaveOutFileA( LPTTS_HANDLE_T, char *, DWORD );
MMRESULT TextToSpeechOpenWaveOutFileW( LPTTS_HANDLE_T, wchar_t *, DWORD );

MMRESULT TextToSpeechCloseWaveOutFile( LPTTS_HANDLE_T );

MMRESULT TextToSpeechLoadUserDictionary( LPTTS_HANDLE_T phTTS, TCHAR *pszFileName );
MMRESULT TextToSpeechLoadUserDictionaryA( LPTTS_HANDLE_T phTTS, char *pszFileName );
MMRESULT TextToSpeechLoadUserDictionaryW( LPTTS_HANDLE_T phTTS, wchar_t *pszFileName );

MMRESULT TextToSpeechReloadMainDictionary( LPTTS_HANDLE_T phTTS, TCHAR *sFileName);
MMRESULT TextToSpeechReloadMainDictionaryA( LPTTS_HANDLE_T phTTS, char *sFileName);
...
MMRESULT TextToSpeechOpenLogFile( LPTTS_HANDLE_T, TCHAR *, DWORD );
MMRESULT TextToSpeechOpenLogFileA( LPTTS_HANDLE_T, char *, DWORD );
...
#define _TextToSpeechStartupExFonix			TextToSpeechStartupExFonixA
#define _TextToSpeechStartLang				TextToSpeechStartLangA
#define _TextToSpeechCloseLang				TextToSpeechCloseLangA
#define _TextToSpeechSpeak					TextToSpeechSpeakA
#define _TextToSpeechOpenWaveOutFile		TextToSpeechOpenWaveOutFileA
#define _TextToSpeechLoadUserDictionary		TextToSpeechLoadUserDictionaryA
#define _TextToSpeechReloadMainDictionary	TextToSpeechReloadMainDictionaryA
#define _TextToSpeechVersion				TextToSpeechVersionA
#define _TextToSpeechOpenLogFile			TextToSpeechOpenLogFileA
#define _TextToSpeechTyping					TextToSpeechTypingA
#endif
...
MMRESULT TextToSpeechGetStatusEx(LPTTS_HANDLE_T, int *, int *, void **);
