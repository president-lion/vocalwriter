...
struct	langs	lp[NO_LANGS] = {
      ...
      {japanese, 0, 0, ' ', 0L, NAME_JAPANESE}
      {hebrew, 0, 0, ' ', 0L, NAME_HEBREW}
      {chinese, 0, 0, ' ', 0L, NAME_CHINESE}
      {korean, 0, 0, ' ', 0L, NAME_KOREAN}
};*/


const unsigned char *CONSTCONST name_types[] =  {
	"English",
	"French",
	"Germanic",
	"Irish",
 ...
 */
const unsigned char *CONSTCONST elim_rules[] = {
	"eiC*",
	"CVN#",
	"eCVN#",
	"yCVN#",
