...
#endif
#ifdef JAPANESE
#define DICT_LANG LANG_japanese
#endif
#ifdef HEBREW
#define DICT_LANG LANG_hebrew
#endif
#ifdef CHINESE
#define DICT_LANG LANG_chinese
#endif
#ifdef KOREAN
#define DICT_LANG LANG_korean
#endif
#ifdef FRENCH
...
#define DICT_INDEX_NC       (pKsd_t->fdic_index[DICT_LANG])
#define FDICT_INDEX_NC      (pKsd_t->foreigndic_index[DICT_LANG])
#define UDICT_INDEX_NC      (pKsd_t->udic_index[DICT_LANG])
#define ADICT_INDEX_NC      (pKsd_t->adic_index[DICT_LANG])
