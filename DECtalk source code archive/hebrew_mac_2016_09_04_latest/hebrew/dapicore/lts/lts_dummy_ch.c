...
const unsigned char ch_main_dict[]= 
{ 0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,
  0x00,0x00,0x00,0x00};


void ch_lts_loop_2(LPTTS_HANDLE_T phTTS,unsigned short *input)
{
}

#ifdef MULTIPLE_LANGUAGES_LOADED
int ch_lts_main(LPTTS_HANDLE_T phTTS)
{
	return(1);
}

int ch_lts_language_loaded( void )
{
	return 1;
}
#else
...
lts_func_t ch_lts_func = {

	LANG_chinese,
   /*lts_func->pLTSThreadData=*/  //NULL,


   /*lts_func->lts_loop=*/  ch_lts_loop_2 ,
	
   /*lts_func->lts_main=*/ ch_lts_main ,
...
lts_func_t *ch_ls_main_get_lts_funcs(void)
{
#ifdef WIN32_STATIC
	return(NULL);
#else
