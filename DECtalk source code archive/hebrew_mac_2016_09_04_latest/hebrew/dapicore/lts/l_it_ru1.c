...
PHONE * l_it_ru1_orthophon(PLTS_T pLts_t, PHONE * lsp);
...

{
	...
	if ((endp = l_it_ru1_orthophon(pLts_t, lsp)) == NULL)
	    goto oops;
...
#endif
	if (l_it_ad1_syll(pLts_t, lsp, endp) == NULL) {        /* Syllabify & stress   */
...
static const char    stress_phone_tab[LS_ANY_STRESS] = {
	SIL,                    /* No stress            */
	S1,
	S2,
	S1,
...
static const char fonemequiv[] = {
      /* @ .. G */   IT_NH,   IT_A,   IT_B,   NOVALID,IT_D,   IT_E,   IT_F,   NOVALID,
      /* H .. O */   NOVALID,IT_I,   IT_J,   IT_K,   IT_L,   IT_M,   IT_N,   IT_O,
      /* P .. W */   IT_P,   NOVALID,NOVALID,NOVALID,IT_T,   NOVALID,IT_B,   NOVALID,
      /* X .. Z */   NOVALID,IT_Y,   IT_TH,   NOVALID,NOVALID,NOVALID,NOVALID,NOVALID
      };
...
/*
 *      Function Name: l_it_ru1_orthophon()      
 *
