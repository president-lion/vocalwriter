...
int sp_lts_language_loaded( void )
{
	return 1;
}
#else
...
#endif
lts_func_t sp_lts_func = {

	LANG_spanish,
   /*lts_func->pLTSThreadData=*/  //NULL,


   /*lts_func->lts_loop=*/  sp_lts_loop_2 ,
   /*lts_func->lts_main=*/ sp_lts_main ,
...
lts_func_t *sp_ls_main_get_lts_funcs(void)
{
#ifdef WIN32_STATIC
	return(NULL);
#else
