...
const unsigned char hb_main_dict[]= 
{ 0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,
  0x00,0x00,0x00,0x00};


void hb_lts_loop_2(LPTTS_HANDLE_T phTTS,unsigned short *input)
{
}

#ifdef MULTIPLE_LANGUAGES_LOADED
int hb_lts_main(LPTTS_HANDLE_T phTTS)
{
	return(1);
}

int hb_lts_language_loaded( void )
{
	return 1;
}
#else
...
lts_func_t hb_lts_func = {

	LANG_hebrew,
   /*lts_func->pLTSThreadData=*/  //NULL,


   /*lts_func->lts_loop=*/  hb_lts_loop_2 ,
	
   /*lts_func->lts_main=*/ hb_lts_main ,
...
lts_func_t *hb_ls_main_get_lts_funcs(void)
{
#ifdef WIN32_STATIC
	return(NULL);
#else
