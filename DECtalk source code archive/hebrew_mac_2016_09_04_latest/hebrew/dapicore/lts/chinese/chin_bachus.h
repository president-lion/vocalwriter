...
BOOL morphemize_word(const ASCIILETTER *, ASCIILETTER *, ASCIILETTER *, WalkCNTXT *, const CHIN_wordgrammarinfo *);
BOOL analyse_word(const ASCIILETTER *, ASCIILETTER *, ASCIILETTER *, WalkCNTXT *, const CHIN_wordgrammarinfo *);
