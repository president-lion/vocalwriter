...
#if defined JAPANESE || defined EPSON_ARM7 || defined MULTIPLE_LANGUAGES_LOADED
#include "onsei.h"
#endif

#if defined KOREAN || defined EPSON_ARM7 || defined MULTIPLE_LANGUAGES_LOADED
#include "phonetic.h"
#include "dccread.h"
...
/* ifdef BACHUS_I_INCLUDED */
	const wordgrammarinfo *bachus_wordgrammarinfo;    /* BACHUS REWT */
...
//	int		current_word_pos;
	U16		output_phones[20];
	int		output_phone_pos;
	int		num_words;
...
#endif
#if defined JAPANESE || defined EPSON_ARM7 || defined MULTIPLE_LANGUAGES_LOADED
	U8 j_inbuf[5*MAX_INERT*2+1];
	U8 j_talkbuf[5*MAX_SPEAK];
	U8 j_sentbuf[5*MAX_SENT*2];
	U8 j_decbuf[5*MAX_SPEAK];
#endif
#ifdef KOREAN
	DccPtr  pDccInfo;
#endif
