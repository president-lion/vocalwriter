...
int la_lts_language_loaded( void )
{
	return 1;
}
#else
...
lts_func_t la_lts_func = {

	LANG_latin_american,
   /*lts_func->pLTSThreadData=*/  //NULL,


   /*lts_func->lts_loop=*/  la_lts_loop_2 ,
   /*lts_func->lts_main=*/ la_lts_main ,
...
lts_func_t *la_ls_main_get_lts_funcs(void)
{
#ifdef WIN32_STATIC
	return(NULL);
#else
