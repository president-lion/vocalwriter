...
const unsigned char kr_main_dict[]= 
{ 0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,
  0x00,0x00,0x00,0x00};


void kr_lts_loop_2(LPTTS_HANDLE_T phTTS,unsigned short *input)
{
}

#ifdef MULTIPLE_LANGUAGES_LOADED
int kr_lts_main(LPTTS_HANDLE_T phTTS)
{
	return(1);
}

int kr_lts_language_loaded( void )
{
	return 1;
}
#else
...
lts_func_t kr_lts_func = {

	LANG_korean,
   /*lts_func->pLTSThreadData=*/  //NULL,


   /*lts_func->lts_loop=*/  kr_lts_loop_2 ,
   /*lts_func->lts_main=*/ kr_lts_main ,
...
lts_func_t *kr_ls_main_get_lts_funcs(void)
{
#ifdef WIN32_STATIC
	return(NULL);
#else
