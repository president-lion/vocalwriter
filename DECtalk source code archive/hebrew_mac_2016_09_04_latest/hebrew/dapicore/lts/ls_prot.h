...
//int italian_word_lts(char *inword, char *outphonemes,	WalkCNTXT *Walkercntxt);

#endif
#ifdef JAPANESE
extern  struct PHONE *l_jp_ad1_syll(PLTS_T pLts_t, struct PHONE *wordp, struct PHONE *endp);
extern  int l_jp_ad1_syllword(PLTS_T pLts_t, struct PHONE *wstart, struct PHONE *wend);
extern  struct PHONE *l_jp_ad1_dosyllable(PLTS_T pLts_t, struct PHONE *wstart, struct PHONE *endp, int isfinal);
extern  struct PHONE *l_jp_ad1_fin_coda(struct PHONE *wstart, struct PHONE *endp);
extern  struct PHONE *l_jp_ad1_int_coda(struct PHONE *wstart, struct PHONE *endp);
extern  struct PHONE *l_jp_ad1_nucleus(PLTS_T pLts_t, struct PHONE *wstart, struct PHONE *endp, int isfinal);
extern  struct PHONE *l_jp_ad1_onset(struct PHONE *wstart, struct PHONE *endp);
extern  int l_jp_ad1_sonset(struct PHONE *lsp);
extern  struct PHONE *l_jp_ad1_wordstart(PLTS_T pLts_t, struct PHONE *wstart, struct PHONE *endp);
extern  void l_jp_ad1_stress(struct PHONE *wstart, struct PHONE *wend, int syllcount);
//int japanese_word_lts(char *inword, char *outphonemes,	WalkCNTXT *Walkercntxt);

#endif
#ifdef HEBREW
extern  struct PHONE *l_hb_ad1_syll(PLTS_T pLts_t, struct PHONE *wordp, struct PHONE *endp);
extern  int l_hb_ad1_syllword(PLTS_T pLts_t, struct PHONE *wstart, struct PHONE *wend);
extern  struct PHONE *l_hb_ad1_dosyllable(PLTS_T pLts_t, struct PHONE *wstart, struct PHONE *endp, int isfinal);
extern  struct PHONE *l_hb_ad1_fin_coda(struct PHONE *wstart, struct PHONE *endp);
extern  struct PHONE *l_hb_ad1_int_coda(struct PHONE *wstart, struct PHONE *endp);
extern  struct PHONE *l_hb_ad1_nucleus(PLTS_T pLts_t, struct PHONE *wstart, struct PHONE *endp, int isfinal);
extern  struct PHONE *l_hb_ad1_onset(struct PHONE *wstart, struct PHONE *endp);
extern  int l_hb_ad1_sonset(struct PHONE *lsp);
extern  struct PHONE *l_hb_ad1_wordstart(PLTS_T pLts_t, struct PHONE *wstart, struct PHONE *endp);
extern  void l_hb_ad1_stress(struct PHONE *wstart, struct PHONE *wend, int syllcount);
//int hebrew_word_lts(char *inword, char *outphonemes,	WalkCNTXT *Walkercntxt);

#endif

#ifdef CHINESE
extern  struct PHONE *l_ch_ad1_syll(PLTS_T pLts_t, struct PHONE *wordp, struct PHONE *endp);
extern  int l_ch_ad1_syllword(PLTS_T pLts_t, struct PHONE *wstart, struct PHONE *wend);
extern  struct PHONE *l_ch_ad1_dosyllable(PLTS_T pLts_t, struct PHONE *wstart, struct PHONE *endp, int isfinal);
extern  struct PHONE *l_ch_ad1_fin_coda(struct PHONE *wstart, struct PHONE *endp);
extern  struct PHONE *l_ch_ad1_int_coda(struct PHONE *wstart, struct PHONE *endp);
extern  struct PHONE *l_ch_ad1_nucleus(PLTS_T pLts_t, struct PHONE *wstart, struct PHONE *endp, int isfinal);
extern  struct PHONE *l_ch_ad1_onset(struct PHONE *wstart, struct PHONE *endp);
extern  int l_ch_ad1_sonset(struct PHONE *lsp);
extern  struct PHONE *l_ch_ad1_wordstart(PLTS_T pLts_t, struct PHONE *wstart, struct PHONE *endp);
extern  void l_ch_ad1_stress(struct PHONE *wstart, struct PHONE *wend, int syllcount);
//int chinese_word_lts(char *inword, char *outphonemes,	WalkCNTXT *Walkercntxt);

#endif
#ifdef KOREAN
extern  struct PHONE *l_kr_ad1_syll(PLTS_T pLts_t, struct PHONE *wordp, struct PHONE *endp);
extern  int l_kr_ad1_syllword(PLTS_T pLts_t, struct PHONE *wstart, struct PHONE *wend);
extern  struct PHONE *l_kr_ad1_dosyllable(PLTS_T pLts_t, struct PHONE *wstart, struct PHONE *endp, int isfinal);
extern  struct PHONE *l_kr_ad1_fin_coda(struct PHONE *wstart, struct PHONE *endp);
extern  struct PHONE *l_kr_ad1_int_coda(struct PHONE *wstart, struct PHONE *endp);
extern  struct PHONE *l_kr_ad1_nucleus(PLTS_T pLts_t, struct PHONE *wstart, struct PHONE *endp, int isfinal);
extern  struct PHONE *l_kr_ad1_onset(struct PHONE *wstart, struct PHONE *endp);
extern  int l_kr_ad1_sonset(struct PHONE *lsp);
extern  struct PHONE *l_kr_ad1_wordstart(PLTS_T pLts_t, struct PHONE *wstart, struct PHONE *endp);
extern  void l_kr_ad1_stress(struct PHONE *wstart, struct PHONE *wend, int syllcount);
//int korean_word_lts(char *inword, char *outphonemes,	WalkCNTXT *Walkercntxt);
...
#if defined (ENGLISH) || defined SPANISH || defined ITALIAN || defined JAPANESE || defined KOREAN || defined HEBREW
...
#if defined (ENGLISH) || defined (GERMAN) || defined (SPANISH) || defined (ITALIAN) || defined JAPANESE || defined KOREAN || defined HEBREW
...
extern  int    ls_util_is_clause(LPTTS_HANDLE_T phTTS);
...
extern void ls_util_dump_llp_rlp(LPTTS_HANDLE_T phTTS,LETTER *llp, LETTER *rlp, char *message);
extern void ls_util_dump_cword(LPTTS_HANDLE_T phTTS,LETTER word[], char *message);
...
extern void unload_dictionary( void **dict_index, void **dict_data, unsigned int *dict_siz,
						unsigned int * dict_bytes, LPVOID *dicMapStartAddr, DT_HANDLE *dicMapObject,
						DT_HANDLE *dicFileHandle, MEMMAP_T dict_map);

extern int load_dictionary( LPTTS_HANDLE_T phTTS, void **dict_index, void **dict_data,
...
#ifndef ARM7
extern long DictionaryHit(LPTTS_HANDLE_T phTTS, struct dic_entry *entry);
extern MMRESULT DumpDictionary(LPTTS_HANDLE_T phTTS, char *filename);
extern long UserDictionaryHit(LPTTS_HANDLE_T phTTS, struct dic_entry *entry);
extern MMRESULT DumpUserDictionary(LPTTS_HANDLE_T phTTS, char *filename);
extern void *UserDictionaryHead(PKSD_T pKsd_t);
extern int GetUserEntrySize(struct dic_entry *entry);
extern MMRESULT AddUserEntry(LPTTS_HANDLE_T phTTS, struct dic_entry *entry);
extern MMRESULT DeleteUserEntry(LPTTS_HANDLE_T phTTS, struct dic_entry *entry);
extern MMRESULT ChangeUserPhoneme(LPTTS_HANDLE_T phTTS, struct dic_entry *entry, 
								  		   unsigned char *new_phoneme);
extern long GetNumUserEntries(LPTTS_HANDLE_T phTTS);
extern int GetUserEntry(LPTTS_HANDLE_T phTTS, char *gr_ph, int index);
extern MMRESULT SaveUserDictionary(LPTTS_HANDLE_T phTTS, char *filename);
#endif


extern int lsw_main_free_lts_thread_data(PLTS_T pLts_t);
