...
extern const unsigned char *CONSTCONST months[];
...
extern const unsigned char *CONSTCONST punits[];
//BATS 863
extern const unsigned char *CONSTCONST upunits[];
...
extern const unsigned char *CONSTCONST pteens[];
...
extern const unsigned char *CONSTCONST ptens[];  
#ifdef ITALIAN
extern const unsigned char *CONSTCONST ptens_x[];  
...
extern const unsigned char *CONSTCONST pmonths[];
...
extern const unsigned char *CONSTCONST pordin[];
...
extern const unsigned char *CONSTCONST punitsl[];
extern const unsigned char heure[];
extern const unsigned char *CONSTCONST categ[];
...
#ifdef GERMAN
extern const unsigned char maledic[];
extern const unsigned char neuterdic[];
extern const unsigned char femaledic[];
#endif
#ifdef ENGLISH
#ifdef ACNA
...
extern const unsigned char *CONSTCONST ounits[];
...
extern const unsigned char *CONSTCONST oteens[];
...
extern const unsigned char *CONSTCONST otens[]; 
...
extern  const unsigned char *CONSTCONST upunits[];
extern  const unsigned char *CONSTCONST pordunits[];
extern  const unsigned char *CONSTCONST pordtens[];
extern  const unsigned char *CONSTCONST pordteens[];
...
#ifdef JAPANESE // temoprary stuff to get it to work
extern const unsigned char pthe[];
extern const unsigned char pof[];
extern const unsigned char ptrillion[];
extern const unsigned char pquadrillion[];
