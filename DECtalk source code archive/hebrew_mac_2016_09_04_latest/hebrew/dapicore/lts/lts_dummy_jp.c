...
const unsigned char jp_main_dict[]= 
{ 0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,
  0x00,0x00,0x00,0x00};


void jp_lts_loop_2(LPTTS_HANDLE_T phTTS,unsigned short *input)
{
}

#ifdef MULTIPLE_LANGUAGES_LOADED
int jp_lts_main(LPTTS_HANDLE_T phTTS)
{
	return(1);
}

int jp_lts_language_loaded( void )
{
	return 1;
}
#else
...
lts_func_t jp_lts_func = {

	LANG_japanese,
   /*lts_func->pLTSThreadData=*/  //NULL,


   /*lts_func->lts_loop=*/  jp_lts_loop_2 ,
   /*lts_func->lts_main=*/ jp_lts_main ,
...
lts_func_t *jp_ls_main_get_lts_funcs(void)
{
#ifdef WIN32_STATIC
	return(NULL);
#else
