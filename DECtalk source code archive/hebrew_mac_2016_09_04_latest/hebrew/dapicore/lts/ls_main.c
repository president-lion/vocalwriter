...
#endif
#ifdef JAPANESE 
   	default_lang (LANG_japanese, LANG_lts_ready);  
#endif
#ifdef HEBREW 
   	default_lang (LANG_hebrew, LANG_lts_ready);  
#endif
#ifdef CHINESE
   	default_lang (LANG_chinese, LANG_lts_ready);  
#endif
#ifdef KOREAN
   	default_lang (LANG_korean, LANG_lts_ready);  
#endif
