...
unsigned char _far * PrintLangBit(LPTTS_HANDLE_T phTTS, short tmp)
{
	...
	case PFUSA:
		...
		if ((pKsd_t->logflag & LOG_OUTPHON) || (pKsd_t->logflag & LOG_PHONEMES))
		{
			if (FNX_FPRINTF (phTTS->pLogFile, "us_") < 0)
			{
				TextToSpeechErrorHandler (phTTS,
					ERROR_WRITING_FILE,
					0L);
	...
	case PFUK:
		...
		if ((pKsd_t->logflag & LOG_OUTPHON) || (pKsd_t->logflag & LOG_PHONEMES))
		{
			if (FNX_FPRINTF (phTTS->pLogFile, "uk_") < 0)
			{
				TextToSpeechErrorHandler (phTTS,
					ERROR_WRITING_FILE,
					0L);
	...
	case PFSP:
		...
		if ((pKsd_t->logflag & LOG_OUTPHON) || (pKsd_t->logflag & LOG_PHONEMES))
		{
			if (FNX_FPRINTF (phTTS->pLogFile, "sp_") < 0)
			{
				TextToSpeechErrorHandler (phTTS,
					ERROR_WRITING_FILE,
					0L);
	...
	case PFLA:
		...
		if ((pKsd_t->logflag & LOG_OUTPHON) || (pKsd_t->logflag & LOG_PHONEMES))
		{
			if (FNX_FPRINTF (phTTS->pLogFile, "la_") < 0)
			{
				TextToSpeechErrorHandler (phTTS,
					ERROR_WRITING_FILE,
					0L);
	...
	case PFGR:
		...
		if ((pKsd_t->logflag & LOG_OUTPHON) || (pKsd_t->logflag & LOG_PHONEMES))
		{
			if (FNX_FPRINTF (phTTS->pLogFile, "gr_") < 0)
			{
				TextToSpeechErrorHandler (phTTS,
					ERROR_WRITING_FILE,
					0L);
	...
	case PFFR:
		...
		if ((pKsd_t->logflag & LOG_OUTPHON) || (pKsd_t->logflag & LOG_PHONEMES))
		{
			if (FNX_FPRINTF (phTTS->pLogFile, "fr_") < 0)
			{
				TextToSpeechErrorHandler (phTTS,
					ERROR_WRITING_FILE,
					0L);
	...
	case PFJP:
		...
		if ((pKsd_t->logflag & LOG_OUTPHON) || (pKsd_t->logflag & LOG_PHONEMES))
		{
			if (FNX_FPRINTF (phTTS->pLogFile, "jp_") < 0)
			{
				TextToSpeechErrorHandler (phTTS,
					ERROR_WRITING_FILE,
					0L);
	...
	case PFKR:
		...
		if ((pKsd_t->logflag & LOG_OUTPHON) || (pKsd_t->logflag & LOG_PHONEMES))
		{
			if (FNX_FPRINTF (phTTS->pLogFile, "kr_") < 0)
			{
				TextToSpeechErrorHandler (phTTS,
					ERROR_WRITING_FILE,
					0L);
	...
	case PFCH:
		...
		if ((pKsd_t->logflag & LOG_OUTPHON) || (pKsd_t->logflag & LOG_PHONEMES))
		{
			if (FNX_FPRINTF (phTTS->pLogFile, "ch_") < 0)
			{
				TextToSpeechErrorHandler (phTTS,
					ERROR_WRITING_FILE,
					0L);
	...
	case PFHE:
		...
		if ((pKsd_t->logflag & LOG_OUTPHON) || (pKsd_t->logflag & LOG_PHONEMES))
		{
			if (FNX_FPRINTF (phTTS->pLogFile, "he_") < 0)
			{
				TextToSpeechErrorHandler (phTTS,
					ERROR_WRITING_FILE,
					0L);
