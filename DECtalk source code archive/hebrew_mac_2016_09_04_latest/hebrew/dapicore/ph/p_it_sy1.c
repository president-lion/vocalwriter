...
#ifndef P_IT_SY1
#define P_IT_SY1
const unsigned char           it_ascky_check[] =
{
...
const unsigned char          *CONSTCONST it_common_affixes[] =
{
	"mi'ento",
	0
};

const unsigned char           it_syl_vowels[] = "aeiouI";

const unsigned char          *CONSTCONST it_syl_cons[] =
{
...
void it_saysyllable (LPTTS_HANDLE_T phTTS) /* changed name from nsaysyllable MGS */
{
	int                     i;
	int                     last, old_tot;
