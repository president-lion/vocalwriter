...
const unsigned char* CONSTCONST phoneme_modes[] = {
	"asky",
	"arpabet",
	"speak",
	"silent",
 ...
 */
const unsigned char* CONSTCONST log_options[] = {
	"text",
	"phonemes",
	"types",
	"forms",
 ...
 */
const unsigned char* CONSTCONST say_options[] = {
	"clause",
	"word",
	"letter",
	"filtered_letter",
 ...
 */
const unsigned char* CONSTCONST error_options[] = {
	"ignore",
	"text",
	"escape",
	"speak",
 ...
 *
 */
const unsigned char* CONSTCONST flush_options[] = {
	"all",
	"until",
	"mask",
	"after",
 ...
 *  are dealt with ...
 */
const unsigned char* CONSTCONST punct_options[] = {
	"none",
	"some",
	"all",
	"pass",
 ...
 *  are dealt with ...
 */
const unsigned char* CONSTCONST skip_options[] = {
	"none",
	"email",
	"punct",
	"rule",
 ...
 *  change the volume 
 */
const unsigned char* CONSTCONST volume_options[] = {
	"set",
	"up",
	"down",
	"lset",
...
#ifdef MSDOS
const unsigned char* CONSTCONST lang_options[] = {
	"english",
	"british",
	"french",
	"german",
 ...
 */
const unsigned char* CONSTCONST power_options[] = {
 ...
 * version stuff
 */
const unsigned char* CONSTCONST version_options[] = {
	"speak",
	"status",
	0
	};
 ...
 * [:tsr  stuff
 */
const unsigned char* CONSTCONST tsr_options[] = {
	"on",
	"off",
	0
	};
...
/* Used in cm_cmd_mode() */
const unsigned char* CONSTCONST mode_options[] = {
	"math",
	"europe",
	"spell",
	"name",
...
const unsigned char* CONSTCONST pronounce_options[] = {
	"alternate",
	"name",
	"primary",
	"noun",
 ...
 */
#ifndef EPSON_ARM7
const unsigned char *CONSTCONST voice_names[] = {
	"paul",
	"betty",
	"harry",
	"frank",
 ...
 */
const unsigned char *CONSTCONST index_options[] = {
	"mark",
	"reply",
	"query",
	"pause",
...
const unsigned char *CONSTCONST gender_options[] = {
	"masculine",
	"neuter",
	"feminine",
	0
 ...
 */
const unsigned char *CONSTCONST define_options[] = {
...
CONSTSTRUCT struct dtpc_command command_table[] = {
    ...
    {"nw","",0,DCS_NAME_WENDY,cm_cmd_name},
    {"ne","",0,DCS_NAME_ED,cm_cmd_name},
    {"nm","",0,DCS_NAME_MATT,cm_cmd_name},
    {"ns","",0,DCS_NAME_SUE,cm_cmd_name},
    {"ny","",0,DCS_NAME_MARY,cm_cmd_name},
    {"nl","",0,DCS_NAME_LYNN,cm_cmd_name},
    {"nt","",0,DCS_NAME_TOM,cm_cmd_name},
    {"ni","",0,DCS_NAME_IVAN,cm_cmd_name},
    {"nc","",0,DCS_NAME_CHARLINE,cm_cmd_name},
    {"na","",0,DCS_NAME_ARLENE,cm_cmd_name},
	...
	{"ltslanguage","a",1,DCS_LANGUAGE,cm_cmd_ltslanguage},
#ifdef MSDOS
