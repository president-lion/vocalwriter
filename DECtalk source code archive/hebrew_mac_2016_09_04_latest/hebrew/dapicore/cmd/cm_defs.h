...
#ifdef ACCESS32
#define  MIN_SPEAKING_RATE   15			// Slowtalk for Kurtzweil
#else
#define  MIN_SPEAKING_RATE   15
#endif	/* ACCESS32 */
...
#define SKIP_email              0x01
#define SKIP_punct              0x02
#define SKIP_rule               0x04
#define SKIP_all                0x07
#define SKIP_cpg                0x08
#define SKIP_parser				0x10
