...
#endif
			if(pVtm_t->parambuff[OUT_PH+1] == USP_V)
		{
			pVtm_t->llframe.NAV += 1;
			pVtm_t->llframe.NAF -= 3;
...
//			speakerDef->speaker.NewtonInterpTimeStep = .01f;
	...
	case Rita:	/*Rita*/
		//really sue
			...
			speakerDef->speaker.agm = (float) pVtm_t->NOM_VOIC_GLOT_AREA/100;;
			speakerDef->speaker.OQm = pVtm_t->NOM_Open_Quo;
			speakerDef->speaker.B1m = 140;
			speakerDef->speaker.B2m=  220;
