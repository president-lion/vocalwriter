...
!MESSAGE No configuration specified. Defaulting to Ttstst - Win32 ALPHA A2ADebug United Kingdom.
!ENDIF 

!IF "$(CFG)" != "Ttstst - Win32 A2WRel" && "$(CFG)" != "Ttstst - Win32 A2WDebug" && "$(CFG)" != "Ttstst - Win32 A2ADebug" && "$(CFG)" != "Ttstst - Win32 A2ARel" && "$(CFG)" != "Ttstst - Win32 W2ADebug" && "$(CFG)" != "Ttstst - Win32 W2ARel" && "$(CFG)" != "Ttstst - Win32 W2WDebug" && "$(CFG)" != "Ttstst - Win32 W2WRel" && "$(CFG)" != "Ttstst - Win32 (ALPHA) A2ADebug" && "$(CFG)" != "Ttstst - Win32 (ALPHA) A2ARel" && "$(CFG)" != "Ttstst - Win32 (ALPHA) A2WDebug" && "$(CFG)" != "Ttstst - Win32 (ALPHA) A2WRel" && "$(CFG)" != "Ttstst - Win32 (ALPHA) W2ADebug" && "$(CFG)" != "Ttstst - Win32 (ALPHA) W2ARel" && "$(CFG)" != "Ttstst - Win32 (ALPHA) W2WDebug" && "$(CFG)" != "Ttstst - Win32 (ALPHA) W2WRel" && "$(CFG)" != "Ttstst - Win32 A2ARel Spanish" && "$(CFG)" != "Ttstst - Win32 A2ADebug Spanish" && "$(CFG)" != "Ttstst - Win32 A2ARel German" && "$(CFG)" != "Ttstst - Win32 A2ADebug German" && "$(CFG)" != "Ttstst - Win32 A2ARel Latin American" && "$(CFG)" != "Ttstst - Win32 A2ADebug Latin American" && "$(CFG)" != "Ttstst - Win32 ALPHA A2ARel" && "$(CFG)" != "Ttstst - Win32 ALPHA A2ADebug" && "$(CFG)" != "Ttstst - Win32 ALPHA A2ARel Spanish" && "$(CFG)" !=\
 "Ttstst - Win32 ALPHA A2ARel German" && "$(CFG)" != "Ttstst - Win32 ALPHA A2ARel Latin American" && "$(CFG)" != "Ttstst - Win32 ALPHA A2ADebug Spanish" && "$(CFG)" != "Ttstst - Win32 ALPHA A2ADebug German" && "$(CFG)" != "Ttstst - Win32 ALPHA A2ADebug Latin American" && "$(CFG)" != "Ttstst - Win32 A2ARel United Kingdom" && "$(CFG)" != "Ttstst - Win32 A2ADebug United Kingdom" && "$(CFG)" != "Ttstst - Win32 ALPHA A2ARel United Kingdom" && "$(CFG)" != "Ttstst - Win32 ALPHA A2ADebug United Kingdom"
...
LINK32=link.exe
LINK32_FLAGS=ole32.lib uuid.lib winmm.lib /nologo /subsystem:windows /incremental:yes /pdb:"$(OUTDIR)\Ttstst.pdb" /debug /machine:ALPHA /out:"$(OUTDIR)\Ttstst.exe" 
LINK32_OBJS= \
	"$(INTDIR)\TTSTST.res"
...
LINK32=link.exe
LINK32_FLAGS=ole32.lib uuid.lib winmm.lib /nologo /subsystem:windows /incremental:no /pdb:"$(OUTDIR)\Ttstst.pdb" /machine:ALPHA /out:"$(OUTDIR)\Ttstst.exe" 
LINK32_OBJS= \
	"$(INTDIR)\TTSTST.res"
...
LINK32=link.exe
LINK32_FLAGS=ole32.lib uuid.lib winmm.lib /nologo /entry:"wWinMainCRTStartup" /subsystem:windows /incremental:yes /pdb:"$(OUTDIR)\Ttstst.pdb" /debug /machine:ALPHA /out:"$(OUTDIR)\Ttstst.exe" 
LINK32_OBJS= \
	"$(INTDIR)\TTSTST.res"
...
LINK32=link.exe
LINK32_FLAGS=ole32.lib uuid.lib winmm.lib /nologo /entry:"wWinMainCRTStartup" /subsystem:windows /incremental:no /pdb:"$(OUTDIR)\Ttstst.pdb" /machine:ALPHA /out:"$(OUTDIR)\Ttstst.exe" 
LINK32_OBJS= \
	"$(INTDIR)\TTSTST.res"
...
LINK32=link.exe
LINK32_FLAGS=..\..\sapi\alpha\dtlkttse\us\release\dtlkttse.lib ole32.lib uuid.lib winmm.lib /nologo /subsystem:windows /incremental:no /pdb:"$(OUTDIR)\Ttstest.pdb" /machine:ALPHA /out:"$(OUTDIR)\Ttstest.exe" 
LINK32_OBJS= \
	"$(INTDIR)\TTSTST.res"
...
OUTDIR=.\alpha\us\A2Adebug
INTDIR=.\alpha\us\A2Adebug\link

ALL : ".\alpha\us\debug\Ttstest.exe"


CLEAN :
	-@erase "$(INTDIR)\TTSTST.res"
	-@erase "$(OUTDIR)\Ttstest.pdb"
	-@erase ".\alpha\us\debug\Ttstest.exe"
	-@erase ".\alpha\us\debug\Ttstest.ilk"
...
LINK32=link.exe
LINK32_FLAGS=..\..\sapi\alpha\dtlkttse\us\debug\dtlkttse.lib ole32.lib uuid.lib winmm.lib /nologo /subsystem:windows /incremental:yes /pdb:"$(OUTDIR)\Ttstest.pdb" /debug /machine:ALPHA /out:".\alpha\us\debug/Ttstest.exe" 
LINK32_OBJS= \
	"$(INTDIR)\TTSTST.res"

".\alpha\us\debug\Ttstest.exe" : "$(OUTDIR)" $(DEF_FILE) $(LINK32_OBJS)
    $(LINK32) @<<
  $(LINK32_FLAGS) $(LINK32_OBJS)
<<
...
LINK32=link.exe
LINK32_FLAGS=..\..\sapi\alpha\dtlkttse\sp\release\dtlkttse.lib ole32.lib uuid.lib winmm.lib /nologo /subsystem:windows /incremental:no /pdb:"$(OUTDIR)\Ttstest.pdb" /machine:ALPHA /out:"$(OUTDIR)\Ttstest.exe" 
LINK32_OBJS= \
	"$(INTDIR)\TTSTST.res"
...
LINK32=link.exe
LINK32_FLAGS=..\..\sapi\alpha\dtlkttse\gr\release\dtlkttse.lib ole32.lib uuid.lib winmm.lib /nologo /subsystem:windows /incremental:no /pdb:"$(OUTDIR)\Ttstest.pdb" /machine:ALPHA /out:"$(OUTDIR)\Ttstest.exe" 
LINK32_OBJS= \
	"$(INTDIR)\TTSTST.res"
...
LINK32=link.exe
LINK32_FLAGS=..\..\sapi\alpha\dtlkttse\la\release\dtlkttse.lib ole32.lib uuid.lib winmm.lib /nologo /subsystem:windows /incremental:no /pdb:"$(OUTDIR)\Ttstest.pdb" /machine:ALPHA /out:"$(OUTDIR)\Ttstest.exe" 
LINK32_OBJS= \
	"$(INTDIR)\TTSTST.res"
...
OUTDIR=.\alpha\sp\A2Adebug
INTDIR=.\alpha\sp\A2Adebug\link

ALL : ".\alpha\sp\debug\Ttstest.exe"


CLEAN :
	-@erase "$(INTDIR)\TTSTST.res"
	-@erase "$(OUTDIR)\Ttstest.pdb"
	-@erase ".\alpha\sp\debug\Ttstest.exe"
	-@erase ".\alpha\sp\debug\Ttstest.ilk"
...
LINK32=link.exe
LINK32_FLAGS=..\..\sapi\alpha\dtlkttse\sp\debug\dtlkttse.lib ole32.lib uuid.lib winmm.lib /nologo /subsystem:windows /incremental:yes /pdb:"$(OUTDIR)\Ttstest.pdb" /debug /machine:ALPHA /out:".\alpha\sp\debug/Ttstest.exe" 
LINK32_OBJS= \
	"$(INTDIR)\TTSTST.res"

".\alpha\sp\debug\Ttstest.exe" : "$(OUTDIR)" $(DEF_FILE) $(LINK32_OBJS)
    $(LINK32) @<<
  $(LINK32_FLAGS) $(LINK32_OBJS)
<<
...
OUTDIR=.\alpha\gr\A2Adebug
INTDIR=.\alpha\gr\A2Adebug\link

ALL : ".\alpha\gr\debug\Ttstest.exe"


CLEAN :
	-@erase "$(INTDIR)\TTSTST.res"
	-@erase "$(OUTDIR)\Ttstest.pdb"
	-@erase ".\alpha\gr\debug\Ttstest.exe"
	-@erase ".\alpha\gr\debug\Ttstest.ilk"
...
LINK32=link.exe
LINK32_FLAGS=..\..\sapi\alpha\dtlkttse\gr\debug\dtlkttse.lib ole32.lib uuid.lib winmm.lib /nologo /subsystem:windows /incremental:yes /pdb:"$(OUTDIR)\Ttstest.pdb" /debug /machine:ALPHA /out:".\alpha\gr\debug/Ttstest.exe" 
LINK32_OBJS= \
	"$(INTDIR)\TTSTST.res"

".\alpha\gr\debug\Ttstest.exe" : "$(OUTDIR)" $(DEF_FILE) $(LINK32_OBJS)
    $(LINK32) @<<
  $(LINK32_FLAGS) $(LINK32_OBJS)
<<
...
OUTDIR=.\alpha\la\A2Adebug
INTDIR=.\alpha\la\A2Adebug\link

ALL : ".\alpha\la\debug\Ttstest.exe"


CLEAN :
	-@erase "$(INTDIR)\TTSTST.res"
	-@erase "$(OUTDIR)\Ttstest.pdb"
	-@erase ".\alpha\la\debug\Ttstest.exe"
	-@erase ".\alpha\la\debug\Ttstest.ilk"
...
LINK32=link.exe
LINK32_FLAGS=..\..\sapi\alpha\dtlkttse\la\debug\dtlkttse.lib ole32.lib uuid.lib winmm.lib /nologo /subsystem:windows /incremental:yes /pdb:"$(OUTDIR)\Ttstest.pdb" /debug /machine:ALPHA /out:".\alpha\la\debug/Ttstest.exe" 
LINK32_OBJS= \
	"$(INTDIR)\TTSTST.res"

".\alpha\la\debug\Ttstest.exe" : "$(OUTDIR)" $(DEF_FILE) $(LINK32_OBJS)
    $(LINK32) @<<
  $(LINK32_FLAGS) $(LINK32_OBJS)
<<
...
LINK32=link.exe
LINK32_FLAGS=..\..\sapi\alpha\dtlkttse\sp\release\dtlkttse.lib ole32.lib uuid.lib winmm.lib /nologo /subsystem:windows /incremental:no /pdb:"$(OUTDIR)\Ttstest.pdb" /machine:ALPHA /out:"$(OUTDIR)\Ttstest.exe" /SUBSYSTEM:windows,4.0 
LINK32_OBJS= \
	"$(INTDIR)\TTSTST.res"
...
OUTDIR=.\alpha\uk\A2Adebug
INTDIR=.\alpha\uk\A2Adebug\link
# Begin Custom Macros
OutDir=.\alpha\uk\A2Adebug
# End Custom Macros
...
LINK32=link.exe
LINK32_FLAGS=..\..\sapi\alpha\dtlkttse\uk\debug\dtlkttse.lib winmm.lib /nologo /subsystem:windows /incremental:yes /pdb:"$(OUTDIR)\Ttstest.pdb" /debug /machine:ALPHA /out:"$(OUTDIR)\Ttstest.exe" /SUBSYSTEM:windows,4.0 
LINK32_OBJS= \
	"$(INTDIR)\TTSTST.res"
