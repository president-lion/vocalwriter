...
{{0x52,0x0,0x0},		{"r "}, R     }, /*LATIN CAPITAL LETTER R; (Rat) */
{{0x5F,0x0,0x0},		{"_ "}, SIL   }, /*LOW LINE; (silence) */
{{0x61,0x26A,0x0},		{"ay"}, AY    }, /*LATIN SMALL LETTER A + LATIN LETTER SMALL CAPITAL I; (bUY) */
{{0x61,0x28A,0x0},		{"aw"}, AW    }, /*LATIN SMALL LETTER A + LATIN SMALL LETTER UPSILON; (brOW) */
{{0x62,0x0,0x0},		{"b "}, B     }, /*LATIN SMALL LETTER B; (Bad) */
{{0x64,0x32F,0x0},		{"dz"}, DZ    }, /*LATIN SMALL LETTER D + COMBINING INVERTED BREVE BELOW; (wiDth) */
{{0x64,0x0,0x0},		{"d "}, D     }, /*LATIN SMALL LETTER D; (Dad) */
{{0x65,0x0,0x0},		{"ey"}, EY    }, /*LATIN SMALL LETTER E; (bAY) */
{{0x66,0x0,0x0},		{"f "}, F     }, /*LATIN SMALL LETTER F; (Fat) */
{{0x67,0x0,0x0},		{"g "}, G     }, /*LATIN SMALL LETTER G; (Game) */
{{0x68,0x0,0x0},		{"hx"}, HX    }, /*LATIN SMALL LETTER H; (Had) */
{{0x69,0x2B4,0x0},		{"ir"}, IR    }, /*LATIN SMALL LETTER I + MODIFIER LETTER SMALL TURNED R; (pEEr) */
{{0x69,0x0,0x0},		{"iy"}, IY    }, /*LATIN SMALL LETTER I; (bEAn) */
{{0x6A,0x75,0x0},		{"yu"}, YU    }, /*LATIN SMALL LETTER J + LATIN SMALL LETTER U; (cUte) */
{{0x6A,0x0,0x0},		{"yx"}, Y     }, /*LATIN SMALL LETTER J; (Yank) */
{{0x6B,0x0,0x0},		{"k "}, K     }, /*LATIN SMALL LETTER K; (loCH) */
{{0x6C,0x329,0x0},		{"el"}, EL    }, /*LATIN SMALL LETTER L +  COMBINING VERTICAL LINE BELOW; (dangLe) */
{{0x6C,0x0,0x0},		{"l "}, LL    }, /*LATIN SMALL LETTER L; (Lad) */
{{0x6D,0x0,0x0},		{"m "}, M     }, /*LATIN SMALL LETTER M; (idealisM) */
{{0x6E,0x329,0x0},		{"en"}, EN    }, /*LATIN SMALL LETTER N + COMBINING VERTICAL LINE BELOW; (burdeN) */
{{0x6E,0x0,0x0},		{"n "}, N     }, /*LATIN SMALL LETTER N; (Nat) */
{{0x6F,0x28A,0x0},		{"ow"}, OW    }, /*LATIN SMALL LETTER O + LATIN SMALL LETTER UPSILON; (nO) */
{{0x6F,0x0,0x0},		{"ow"}, OW    }, /*LATIN SMALL LETTER O; (nO) */
{{0x70,0x0,0x0},		{"p "}, P     }, /*LATIN SMALL LETTER P; (Pat) */
{{0x72,0x0,0x0},		{"r "}, R     }, /*LATIN SMALL LETTER R; (Rat) */
{{0x73,0x0,0x0},		{"s "}, S     }, /*LATIN SMALL LETTER S; (Sap) */
{{0x74,0x294,0x0},		{"tx"}, TX    }, /*LATIN SMALL LETTER T + LATIN LETTER GLOTTAL STOP; (baTTen) */
{{0x74,0x0,0x0},		{"t "}, T     }, /*LATIN SMALL LETTER T; (Tack) */
{{0x75,0x0,0x0},		{"uw"}, UW    }, /*LATIN SMALL LETTER U; (bOOn) */
{{0x76,0x0,0x0},		{"v "}, V     }, /*LATIN SMALL LETTER V; (Vat) */
{{0x77,0x0,0x0},		{"w "}, W     }, /*LATIN SMALL LETTER W; (Why) */
{{0x7A,0x0,0x0},		{"z "}, Z     }, /*LATIN SMALL LETTER Z; (Zap) */
{{0xE6,0x0,0x0},		{"ae"}, AE    }, /*LATIN SMALL LETTER AE; (pAt) */
{{0xF0,0x0,0x0},		{"dh"}, DH    }, /*LATIN SMALL LETTER ETH; (THen) */
{{0x14B,0x0,0x0},		{"nx"}, NX    }, /*LATIN SMALL LETTER ENG; (baNG) */
{{0x251,0x2B4,0x0},		{"ar"}, AR    }, /*LATIN SMALL LETTER ALPHA + MODIFIER LETTER SMALL TURNED R; (bARn) */
{{0x251,0x0,0x0},		{"aa"}, AA    }, /*LATIN SMALL LETTER ALPHA; (pOt) */
{{0x254,0x26A,0x0},		{"oy"}, OY    }, /*LATIN SMALL LETTER OPEN O + LATIN SMALL LETTER CAPITAL I; (bOY) */
{{0x254,0x2B4,0x0},		{"or"}, OR    }, /*LATIN SMALL LETTER OPEN O + MODIFIER LETTER SMALL TURNED R; (bOrn) */
{{0x254,0x0,0x0},		{"ao"}, AO    }, /*LATIN SMALL LETTER O; (bOUght) */
{{0x259,0x0,0x0},		{"ax"}, AX    }, /*LATIN SMALL LETTER SCHWA; (About) */
{{0x25A,0x0,0x0},		{"rr"}, RR    }, /*LATIN SMALL LETTER SCHWA WITH HOOK; (anothER) */
{{0x25B,0x0,0x0},		{"eh"}, EH    }, /*LATIN SMALL LETTER OPEN E; (pEt) */
{{0x261,0x0,0x0},		{"g "}, G     }, /*LATIN SMALL LETTER SCRIPT G; (Game) */
{{0x268,0x0,0x0},		{"ix"}, IX    }, /*LATIN SMALL LETTER I WITH STROKE; (kissEs) */
{{0x26A,0x0,0x0},		{"ih"}, IH    }, /*LATIN SMALL LETTER CAPITAL I; (tImbre) */
{{0x26B,0x0,0x0},		{"lx"}, LX    }, /*LATIN SMALL LETTER I WITH MIDDLE TILDE; (untiL) */
{{0x279,0x0,0x0},		{"rx"}, RX    }, /*LATIN SMALL LETTER TURNED R WITH HOOK; (coRe) */
{{0x27B,0x0,0x0},		{"rx"}, RX    }, /*LATIN SMALL LETTER TURNED R WITH HOOK; (coRe) */
{{0x27E,0x0,0x0},		{"dx"}, DX    }, /*LATIN SMALL LETTER WITH FISHHOOK; (riDer) */
{{0x283,0x0,0x0},		{"sh"}, SH    }, /*LATIN SMALL LETTER ESH; (SHeep) */
{{0x28A,0x2B4,0x0},		{"ur"}, UR    }, /*LATIN SMALL LETTER UPSILON + MODIFIER LETTER SMALL TURNED R; (pOOr) */
{{0x28A,0x0,0x0},		{"uh"}, UH    }, /*LATIN SMALL LETTER UPSILON; (pUt) */
{{0x28C,0x0,0x0},		{"ah"}, AH    }, /*LATIN SMALL LETTER TURNED V; (pUtt) */
{{0x292,0x0,0x0},		{"zh"}, ZH    }, /*LATIN SMALL LETTER EZH; (meaSure) */
{{0x294,0x0,0x0},		{"q "}, Q     }, /*LATIN LETTER GLOTTAL STOP; (we eat) */
{{0x2A4,0x0,0x0},		{"jh"}, JH    }, /*LATIN SMALL LETTER DEZH DIGRAPH; (Jeep) */
{{0x2A7,0x0,0x0},		{"ch"}, CH    }, /*LATIN SMALL LETTER TESH DIGRAPH; (CHeap) */
...
{{0x3B8,0x0,0x0},		{"th"}, TH    }, /*GREEK SMALL LETTER THETA; (THin) */
...
#pragma message("WP lock code installed in TextData")
	...
	dwDestCount--; // back up to before the null..
	{
		int	iI=0;
		// place a word position mark.. 
		iSubstSize = sprintf(szSubstString,"[:i stop %d %d] ",
			(unsigned int)(pMode->m_dwSequenceNumber>>16), 
			(unsigned int)(pMode->m_dwSequenceNumber&0xFFFF));
