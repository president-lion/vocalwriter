...
/*	013	CAB		03/26/2002	Added auto update of copyright for about				*/
/************************************************************************************/
                    ...
                    LONG lParam)
{
    ...
    {	case WM_INITDIALOG:                     /* message: initialize dialog box */
			swprintf(szCopyright, TEXT("%S %S"), COPYRIGHT_DATE, COPYRIGHT_COMPANY);
			hDlgItem = GetDlgItem( hDlg, IDD_COPYRIGHT );
			SetWindowText( hDlgItem, szCopyright);
